---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/stench-kow-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/cattle"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/cattle"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Stench Kow"]}}
---

# [Stench Kow](Rules\Source\bestiary\fiend/stench-kow-mpmm.md)
...
"traits":
  - "desc": "Any creature other than a stench kow that starts its turn within 5 feet\
      ...
      \ [poisoned](/Rules/Source/conditions.md#Poisoned) until the start of the creature's\
      \ next turn. On a successful saving throw, the creature is immune to the Stench\
      \ of all stench kows for 1 hour."
    "name": "Stench"
"actions":
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/stench-kow-mpmm.webp"
```{ #statblock}
