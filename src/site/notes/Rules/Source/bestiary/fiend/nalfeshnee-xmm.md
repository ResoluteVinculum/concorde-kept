...
"traits":
  ...
  - "desc": "The nalfeshnee has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The nalfeshnee teleports up to 120 feet to an unoccupied space it can\
    ...
    "name": "Teleport"
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 15, each creature in a 15-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/nalfeshnee-xmm.webp"
```{ #statblock}
