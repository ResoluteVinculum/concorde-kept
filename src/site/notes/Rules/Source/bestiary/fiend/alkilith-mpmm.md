...
"traits":
  ...
  - "desc": "Any creature that isn't a demon that starts its turn within 30 feet of\
      ...
      \ fails by 5 or more, the creature is instead subjected to the [confusion](/Rules/Source/spells/confusion-xphb.md)\
      \ spell for 1 minute (no [concentration](/Rules/Source/conditions.md#Concentration)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/alkilith-mpmm.webp"
```{ #statblock}
