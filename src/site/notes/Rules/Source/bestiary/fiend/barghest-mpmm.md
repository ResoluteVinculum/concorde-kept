...
"actions":
  ...
  - "desc": "The barghest casts one of the following spells, requiring no material\
      ...
      \n**At will:** [levitate](/Rules/Source/spells/levitate-xphb.md), [minor illusion](/Rules/Source/spells/minor-illusion-xphb.md),\
      \ [pass without trace](/Rules/Source/spells/pass-without-trace-xphb.md)\n\n\
      **1/day each:** [charm person](/Rules/Source/spells/charm-person-xphb.md), [dimension\
      \ door](/Rules/Source/spells/dimension-door-xphb.md), [suggestion](/Rules/Source/spells/suggestion-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/barghest-mpmm.webp"
```{ #statblock}
