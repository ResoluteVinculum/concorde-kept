---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/swarm-of-larvae-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/lower","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/lower","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Swarm of Larvae"]}}
---

# [Swarm of Larvae](Rules\Source\bestiary\fiend/swarm-of-larvae-xmm.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 9 (2d6 + 2) Necrotic damage,\
      \ or 7 (2d4 + 2) Necrotic damage if the swarm is [Bloodied](/Rules/Source/conditions.md#Bloodied)."
    "name": "Bites"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/swarm-of-larvae-xmm.webp"
```{ #statblock}
