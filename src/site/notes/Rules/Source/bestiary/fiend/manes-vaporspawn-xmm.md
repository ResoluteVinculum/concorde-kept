...
"traits":
  - "desc": "The manes can move through a space as narrow as 1 inch without expending\
    ...
    "name": "Contortionist"
  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 5-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
...
"bonus_actions":
  - "desc": "While in [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md) or\
      \ [Darkness](/Rules/Source/variant-rules/darkness-xphb.md), the manes takes\
      \ the [Hide](/Rules/Source/actions.md#Hide) action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/manes-vaporspawn-xmm.webp"
```{ #statblock}
