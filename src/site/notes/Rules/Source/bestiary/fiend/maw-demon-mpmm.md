---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/maw-demon-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/demon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/demon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Maw Demon"]}}
---

# [Maw Demon](Rules\Source\bestiary\fiend/maw-demon-mpmm.md)
...
| 6 | Old leather boot |
| 7 | Beehive |
| 8 | Humanoid teeth |{ #maw-demons-stomach-contents}
...
"actions":
  ...
  - "desc": "The demon vomits in a 15-foot cube. Each creature in that area must succeed\
      \ on a DC 11 Dexterity saving throw or take 11 (2d10) acid damage and fall [prone](/Rules/Source/conditions.md#Prone)\
      \ in the spew."
    "name": "Disgorge (Recharge 6)"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/maw-demon-mpmm.webp"
```{ #statblock}
