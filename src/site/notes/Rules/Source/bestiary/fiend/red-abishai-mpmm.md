---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/red-abishai-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/19","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/devil"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/19","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/devil"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Red Abishai"]}}
---

# [Red Abishai](Rules\Source\bestiary\fiend/red-abishai-mpmm.md)
...
"actions":
  ...
  - "desc": "Each creature of the abishai's choice that is within 120 feet and aware\
      \ of the abishai must succeed on a DC 18 Wisdom saving throw or become [frightened](/Rules/Source/conditions.md#Frightened)\
  ...
  - "desc": "The abishai chooses up to four other creatures within 60 feet of it that\
      ...
      \ makes attack rolls with advantage and can't be [frightened](/Rules/Source/conditions.md#Frightened)."
  ...
  - "desc": "The abishai targets one Dragon it can see within 120 feet of it. The\
      ...
      \ is [charmed](/Rules/Source/conditions.md#Charmed) by the abishai for 1 hour.\
      \ While [charmed](/Rules/Source/conditions.md#Charmed) in this way, the target\
      \ regards the abishai as a trusted friend to be heeded and protected. This effect\
      \ ends if the abishai or its companions deal damage to the target."
    "name": "Power of the Dragon Queen"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/red-abishai-mpmm.webp"
```{ #statblock}
