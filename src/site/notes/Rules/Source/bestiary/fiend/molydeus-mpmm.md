---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/molydeus-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/21","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fiend/demon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/21","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fiend/demon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Molydeus"]}}
---

# [Molydeus](Rules\Source\bestiary\fiend/molydeus-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +16 to hit, reach 15 ft., one creature. *Hit:*\
      ...
      \ The target transforms into a [manes](/Rules/Source/bestiary/fiend/manes-xmm.md)\
      \ if this reduces its hit point maximum to 0. This transformation can be ended\
      \ only by a [wish](/Rules/Source/spells/wish-xphb.md) spell."
    "name": "Snakebite"
  ...
  - "desc": "The molydeus casts one of the following spells, requiring no material\
      ...
      \n**At will:** [dispel magic](/Rules/Source/spells/dispel-magic-xphb.md), [polymorph](/Rules/Source/spells/polymorph-xphb.md),\
      \ [telekinesis](/Rules/Source/spells/telekinesis-xphb.md), [teleport](/Rules/Source/spells/teleport-xphb.md)\n\
      \n**3/day:** [lightning bolt](/Rules/Source/spells/lightning-bolt-xphb.md)"
    "name": "Spellcasting"
...
"legendary_actions":
  - "desc": "The molydeus makes one Demonic Weapon or Snakebite attack."
    "name": "Attack"
  - "desc": "The molydeus moves without provoking [opportunity attacks](/Rules/Source/actions.md#Opportunity%20Attack)."
    "name": "Move"
  - "desc": "The molydeus uses Spellcasting."
    "name": "Cast a Spell (Costs 2 Actions)"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/molydeus-mpmm.webp"
```
^statblock