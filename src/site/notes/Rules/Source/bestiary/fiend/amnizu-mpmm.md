---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/amnizu-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/18","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/devil"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/18","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/devil"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Amnizu"]}}
---

# [Amnizu](Rules\Source\bestiary\fiend/amnizu-mpmm.md)
...
"cr": "18"
"traits":
  - "desc": "Magical darkness doesn't impede the amnizu's [darkvision](/Rules/Source/senses.md#Darkvision)."
    "name": "Devil's Sight"
...
"actions":
  ...
  - "desc": "The amnizu targets one or two creatures that it can see within 60 feet\
      ...
      \ (4d12) necrotic damage and be [blinded](/Rules/Source/conditions.md#Blinded)\
  ...
  - "desc": "The amnizu targets one creature it can see within 60 feet of it. That\
      ...
      \ psychic damage and become [stunned](/Rules/Source/conditions.md#Stunned) for\
      \ 1 minute. A [stunned](/Rules/Source/conditions.md#Stunned) creature repeats\
      \ the saving throw at the end of each of its turns, ending the effect on itself\
      \ on a success. If the target is [stunned](/Rules/Source/conditions.md#Stunned)\
  ...
  - "desc": "The amnizu casts one of the following spells, requiring no material components\
      ...
      **At will:** [command](/Rules/Source/spells/command-xphb.md)\n\n**3/day:** [dominate\
      \ monster](/Rules/Source/spells/dominate-monster-xphb.md)\n\n**1/day:** [feeblemind](/Rules/Source/spells/befuddlement-xphb.md)"
    "name": "Spellcasting"
"reactions":
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/amnizu-mpmm.webp"
```
^statblock