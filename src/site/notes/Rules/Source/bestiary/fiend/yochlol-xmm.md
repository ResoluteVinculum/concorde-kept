---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/yochlol-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/abyss","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/demon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/abyss","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/demon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Yochlol"]}}
---

# [Yochlol](Rules\Source\bestiary\fiend/yochlol-xmm.md)
...
"traits":
  - "desc": "If the yochlol dies outside the Abyss, its body dissolves, and it gains\
      \ a new body instantly, reviving with all its [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ in the Abyss."
    "name": "Demonic Restoration"
  - "desc": "The yochlol has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "The yochlol makes two Caustic Lash attacks, and it can use Spellcasting\
      \ to cast [Web](/Rules/Source/spells/web-xphb.md) or [Dominate Person](/Rules/Source/spells/dominate-person-xphb.md)\
      \ if available."
    "name": "Multiattack"
  ...
  - "desc": "The yochlol casts one of the following spells, requiring no Material\
      ...
      \ [Gaseous Form](/Rules/Source/spells/gaseous-form-xphb.md) (self only), [Web](/Rules/Source/spells/web-xphb.md)\n\
      \n**1/day:** [Dominate Person](/Rules/Source/spells/dominate-person-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"reactions":
  - "desc": "Trigger: The yochlol is hit by an attack roll. _Response:_ The yochlol\
      ...
      \ *Failure:* The target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition until the end of its next turn. While [Poisoned](/Rules/Source/conditions.md#Poisoned),\
      \ it has the [Incapacitated](/Rules/Source/conditions.md#Incapacitated) condition."
    "name": "Toxic Escape"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/yochlol-xmm.webp"
```{ #statblock}
