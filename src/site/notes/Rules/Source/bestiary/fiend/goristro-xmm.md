---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/goristro-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/environment/abyss","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fiend/demon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/environment/abyss","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fiend/demon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Goristro"]}}
---

# [Goristro](Rules\Source\bestiary\fiend/goristro-xmm.md)
...
"traits":
  ...
  - "desc": "The goristro has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +13, reach 10 ft. *Hit:* 40 (6d10 + 7) Piercing\
      ...
      \ feet straight away from the goristro and has the [Prone](/Rules/Source/conditions.md#Prone)\
      \ condition."
    "name": "Brutal Gore"
  - "desc": "*Melee Attack Roll:* +13, reach 10 ft. *Hit:* 29 (4d10 + 7) Bludgeoning\
    ...
    "name": "Slam"
"bonus_actions":
  - "desc": "The goristro moves up to half its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ straight toward an enemy it can see."
    "name": "Charge"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/goristro-xmm.webp"
```{ #statblock}
