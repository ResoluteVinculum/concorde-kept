---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/oinoloth-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/12","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/yugoloth"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/12","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/yugoloth"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Oinoloth"]}}
---

# [Oinoloth](Rules\Source\bestiary\fiend/oinoloth-mpmm.md)
...
"actions":
  ...
  - "desc": "The oinoloth touches one willing creature within 5 feet of it. The target\
      ...
      \ on the target or remove one of the following conditions from it: [blinded](/Rules/Source/conditions.md#Blinded),\
      \ [deafened](/Rules/Source/conditions.md#Deafened), [paralyzed](/Rules/Source/conditions.md#Paralyzed),\
      \ or [poisoned](/Rules/Source/conditions.md#Poisoned). The target then gains\
      \ 1 level of [exhaustion](/Rules/Source/conditions.md#Exhaustion), and its hit\
      \ point maximum is reduced by 7 (2d6). This reduction can be removed only by\
      \ a [wish](/Rules/Source/spells/wish-xphb.md) spell or by casting [greater restoration](/Rules/Source/spells/greater-restoration-xphb.md)\
  ...
  - "desc": "The oinoloth casts one of the following spells, requiring no material\
      ...
      \ [dispel magic](/Rules/Source/spells/dispel-magic-xphb.md), [hold monster](/Rules/Source/spells/hold-monster-xphb.md),\
      \ [invisibility](/Rules/Source/spells/invisibility-xphb.md) (self only)\n\n\
      **1/day each:** [feeblemind](/Rules/Source/spells/befuddlement-xphb.md), [globe\
...
"bonus_actions":
  - "desc": "The oinoloth blights the area in a 30-foot-radius sphere centered on\
      ...
      \ and is [poisoned](/Rules/Source/conditions.md#Poisoned). On a successful save,\
      \ the creature is immune to the oinoloth's Bringer of Plagues for the next 24\
      \ hours.\n\nThe [poisoned](/Rules/Source/conditions.md#Poisoned) creature can't\
      \ regain hit points. After every 24 hours that elapse, the [poisoned](/Rules/Source/conditions.md#Poisoned)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/oinoloth-mpmm.webp"
```{ #statblock}
