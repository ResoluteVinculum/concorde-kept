---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/lamia-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Lamia"]}}
---

# [Lamia](Rules\Source\bestiary\fiend/lamia-xmm.md)
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, one creature the lamia can see within 5\
      ...
      \ Until the curse ends, the target has the [Charmed](/Rules/Source/conditions.md#Charmed)\
      \ and [Poisoned](/Rules/Source/conditions.md#Poisoned) conditions."
    "name": "Corrupting Touch"
  - "desc": "The lamia casts one of the following spells, requiring no Material components\
      \ and using Charisma as the spellcasting ability (spell save DC 13):\n\n**At\
      \ will:** [Disguise Self](/Rules/Source/spells/disguise-self-xphb.md) (can appear\
      \ as a Large or Medium biped), [Minor Illusion](/Rules/Source/spells/minor-illusion-xphb.md)\n\
      \n**1/day each:** [Geas](/Rules/Source/spells/geas-xphb.md), [Major Image](/Rules/Source/spells/major-image-xphb.md),\
      \ [Scrying](/Rules/Source/spells/scrying-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/lamia-xmm.webp"
```{ #statblock}
