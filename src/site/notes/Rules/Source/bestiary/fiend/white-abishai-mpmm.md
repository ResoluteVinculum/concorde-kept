...
"reactions":
  - "desc": "In response to taking damage, the abishai makes one Bite attack against\
      ...
      \ [opportunity attacks](/Rules/Source/actions.md#Opportunity%20Attack)."
    "name": "Vicious Reprisal"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/white-abishai-mpmm.webp"
```{ #statblock}
