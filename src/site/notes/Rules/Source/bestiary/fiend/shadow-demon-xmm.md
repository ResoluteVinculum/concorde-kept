...
"traits":
  ...
  - "desc": "While in [Bright Light](/Rules/Source/variant-rules/bright-light-xphb.md),\
      \ the demon has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
...
"bonus_actions":
  - "desc": "While in [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md) or\
      \ [Darkness](/Rules/Source/variant-rules/darkness-xphb.md), the demon takes\
      \ the [Hide](/Rules/Source/actions.md#Hide) action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/shadow-demon-xmm.webp"
```{ #statblock}
