---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/sahuagin-priest-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Sahuagin Priest"]}}
---

# [Sahuagin Priest](Rules\Source\bestiary\fiend/sahuagin-priest-xmm.md)
...
"actions":
  ...
  - "desc": "The sahuagin casts one of the following spells, requiring no Material\
      ...
      \ each:** [Hold Person](/Rules/Source/spells/hold-person-xphb.md), [Tongues](/Rules/Source/spells/tongues-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The sahuagin casts [Bless](/Rules/Source/spells/bless-xphb.md) or [Healing\
      \ Word](/Rules/Source/spells/healing-word-xphb.md), using the same spellcasting\
      \ ability as Spellcasting.\n"
    "name": "Fiendish Aid (2/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/sahuagin-priest-xmm.webp"
```{ #statblock}
