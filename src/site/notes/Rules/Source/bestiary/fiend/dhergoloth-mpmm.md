...
"actions":
  ...
  - "desc": "The dhergoloth casts one of the following spells, requiring no material\
      ...
      \n**At will:** [darkness](/Rules/Source/spells/darkness-xphb.md), [fear](/Rules/Source/spells/fear-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/dhergoloth-mpmm.webp"
```{ #statblock}
