---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/rakshasa-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/nine-hells","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/nine-hells","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Rakshasa"]}}
---

# [Rakshasa](Rules\Source\bestiary\fiend/rakshasa-xmm.md)
...
"damage_vulnerabilities": "piercing damage from weapons wielded by creatures under\
  \ the effect of a [Bless](/Rules/Source/spells/bless-xphb.md) spell"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
      ...
      \ While cursed, the target gains no benefit from finishing a [Short](/Rules/Source/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](/Rules/Source/variant-rules/long-rest-xphb.md)."
    "name": "Cursed Touch"
  - "desc": "*Wisdom Saving Throw:* DC 18, each enemy in a 30-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the rakshasa. *Failure:* 28 (8d6) Psychic damage, and the\
      \ target has the [Frightened](/Rules/Source/conditions.md#Frightened) and [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
  ...
  - "desc": "The rakshasa casts one of the following spells, requiring no Material\
      ...
      \n**At will:** [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Detect\
      \ Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md), [Disguise Self](/Rules/Source/spells/disguise-self-xphb.md),\
      \ [Mage Hand](/Rules/Source/spells/mage-hand-xphb.md), [Minor Illusion](/Rules/Source/spells/minor-illusion-xphb.md)\n\
      \n**1/day each:** [Fly](/Rules/Source/spells/fly-xphb.md), [Invisibility](/Rules/Source/spells/invisibility-xphb.md),\
      \ [Major Image](/Rules/Source/spells/major-image-xphb.md), [Plane Shift](/Rules/Source/spells/plane-shift-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/rakshasa-xmm.webp"
```{ #statblock}
