---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/pit-fiend-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/20","ttrpg-cli/monster/environment/nine-hells","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/devil"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/20","ttrpg-cli/monster/environment/nine-hells","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend/devil"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Pit Fiend"]}}
---

# [Pit Fiend](Rules\Source\bestiary\fiend/pit-fiend-xmm.md)
...
"traits":
  - "desc": "If the pit fiend dies outside the Nine Hells, its body disappears in\
      ...
      \ [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md) somewhere in\
      \ the Nine Hells."
    "name": "Diabolical Restoration"
  - "desc": "The pit fiend emanates an aura in a 20-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ while it doesn't have the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      \ condition. *Wisdom Saving Throw:* DC 21, any enemy that starts its turn in\
      \ the aura. *Failure:* The target has the [Frightened](/Rules/Source/conditions.md#Frightened)\
  ...
  - "desc": "The pit fiend has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +14, reach 10 ft. *Hit:* 18 (3d6 + 8) Piercing damage.\
      ...
      \ Saving Throw:* DC 21. *Failure:* The target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition. While [Poisoned](/Rules/Source/conditions.md#Poisoned), the target\
  ...
  - "desc": "*Melee Attack Roll:* +14, reach 10 ft. *Hit:* 22 (4d6 + 8) Force damage\
    ...
    "name": "Fiery Mace"
  - "desc": "The pit fiend casts [Fireball](/Rules/Source/spells/fireball-xphb.md)\
      \ (level 5 version) twice, requiring no Material components and using Charisma\
      \ as the spellcasting ability (spell save DC 21). It can replace one [Fireball](/Rules/Source/spells/fireball-xphb.md)\
      \ with [Hold Monster](/Rules/Source/spells/hold-monster-xphb.md) (level 7 version)\
      \ or [Wall of Fire](/Rules/Source/spells/wall-of-fire-xphb.md).\n"
    "name": "Hellfire Spellcasting (Recharge 4-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/pit-fiend-xmm.webp"
```{ #statblock}
