---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/nupperibo-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/devil"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/devil"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Nupperibo"]}}
---

# [Nupperibo](Rules\Source\bestiary\fiend/nupperibo-mpmm.md)
...
Individually, nupperibos are weak, but they're rarely alone and can be dangerous when gathered into packs. Clouds of stinging insects, [[Rules/Source/bestiary/monstrosity/stirge-xmm\|stirges]], and other vermin surround them in a terrifying, reeking sheath that torments any non-devil that draws near.
...
"senses": "[blindsight](/Rules/Source/senses.md#Blindsight) 20 ft. (blind beyond this\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/nupperibo-mpmm.webp"
```
^statblock