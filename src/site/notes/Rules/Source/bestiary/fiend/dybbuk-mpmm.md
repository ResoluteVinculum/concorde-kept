...
"actions":
  ...
  - "desc": "The dybbuk casts one of the following spells, requiring no material components\
      ...
      \ will:** [dimension door](/Rules/Source/spells/dimension-door-xphb.md)\n\n\
      **3/day:** [phantasmal force](/Rules/Source/spells/phantasmal-force-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "While Possess Corpse is active, the dybbuk makes the corpse do something\
      ...
      \ must succeed on a DC 12 Wisdom saving throw or become [frightened](/Rules/Source/conditions.md#Frightened)\
      \ of the dybbuk for 1 minute. The [frightened](/Rules/Source/conditions.md#Frightened)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/dybbuk-mpmm.webp"
```{ #statblock}
