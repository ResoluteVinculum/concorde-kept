---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/oni-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Oni"]}}
---

# [Oni](Rules\Source\bestiary\fiend/oni-xmm.md)
...
"cr": "7"
"traits":
  - "desc": "The oni regains 10 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "The oni casts one of the following spells, requiring no Material components\
      ...
      \ each:** [Charm Person](/Rules/Source/spells/charm-person-xphb.md) (level 2\
      \ version), [Darkness](/Rules/Source/spells/darkness-xphb.md), [Gaseous Form](/Rules/Source/spells/gaseous-form-xphb.md),\
      \ [Sleep](/Rules/Source/spells/sleep-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The oni casts [Invisibility](/Rules/Source/spells/invisibility-xphb.md)\
      \ on itself, requiring no spell components and using the same spellcasting ability\
      \ as Spellcasting.\n"
    "name": "Invisibility"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/oni-xmm.webp"
```{ #statblock}
