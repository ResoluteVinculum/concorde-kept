---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/maurezhi-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/demon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fiend/demon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Maurezhi"]}}
---

# [Maurezhi](Rules\Source\bestiary\fiend/maurezhi-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 175*  

When Doresain, the King of Ghouls, corrupted a society of elves, he created a new sort of demon—the maurezhi—to lead packs of [[Rules/Source/bestiary/undead/ghoul-xmm\|ghouls]] and [[Rules/Source/bestiary/undead/ghast-xmm\|ghasts]] on the Material Plane.
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 14\
      ...
      \ 24 hours later as a [ghoul](/Rules/Source/bestiary/undead/ghoul-xmm.md)  unless\
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ it must succeed on a DC 12 Constitution saving throw or be [paralyzed](/Rules/Source/conditions.md#Paralyzed)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success."
    "name": "Claw"
  - "desc": "The maurezhi targets one dead ghoul or [ghast](/Rules/Source/bestiary/undead/ghast-xmm.md)\
      \ it can see within 30 feet of it. The target is revived with all its hit points."
    "name": "Raise Ghoul (Recharge 5-6)"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/maurezhi-mpmm.webp"
```{ #statblock}
