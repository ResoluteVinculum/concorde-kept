...
"actions":
  ...
  - "desc": "The nabassu targets one creature it can see within 30 feet of it. If\
      ...
      \ a [ghoul](/Rules/Source/bestiary/undead/ghoul-xmm.md) under the nabassu's\
      \ control."
    "name": "Soul-Stealing Gaze"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fiend/token/nabassu-mpmm.webp"
```{ #statblock}
