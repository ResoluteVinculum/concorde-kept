...
"traits":
  - "desc": "If the arcanaloth dies outside Gehenna, its body dissolves into ichor,\
      \ and it gains a new body instantly and revives with all its [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ in Gehenna."
    "name": "Fiendish Restoration"
  - "desc": "The arcanaloth has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
  ...
  - "desc": "The arcanaloth has a magic tome. While holding or carrying the tome,\
      ...
      \ 35; and [Immunity](/Rules/Source/variant-rules/immunity-xphb.md) to Necrotic,\
      \ Poison, and Psychic damage. The tome regains all its [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      ...
      \ create a new one when it finishes a [Short](/Rules/Source/variant-rules/short-rest-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 10 (2d4 + 5) Slashing damage\
      ...
      \ tome and can escape only if the tome is reduced to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)."
  ...
  - "desc": "The arcanaloth casts one of the following spells, requiring no Material\
      ...
      \ [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Identify](/Rules/Source/spells/identify-xphb.md),\
      \ [Mage Hand](/Rules/Source/spells/mage-hand-xphb.md), [Prestidigitation](/Rules/Source/spells/prestidigitation-xphb.md)\n\
      \n**1/day each:** [Contact Other Plane](/Rules/Source/spells/contact-other-plane-xphb.md),\
      \ [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md), [Dimension\
      \ Door](/Rules/Source/spells/dimension-door-xphb.md), [Mind Blank](/Rules/Source/spells/mind-blank-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The arcanaloth teleports up to 30 feet to an unoccupied space it can\
    ...
    "name": "Teleport"
"reactions":
  - "desc": "The arcanaloth casts [Counterspell](/Rules/Source/spells/counterspell-xphb.md)\
      \ in response to that spell's trigger, using the same spellcasting ability as\
      \ Spellcasting.\n"
    "name": "Counterspell"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/arcanaloth-xmm.webp"
```{ #statblock}
