---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fiend/jackalwere-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/fiend"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/fiend"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Jackalwere"]}}
---

# [Jackalwere](Rules\Source\bestiary\fiend/jackalwere-xmm.md)
...
"cr": "1/2"
"traits":
  - "desc": "The jackalwere has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 10, one creature the jackalwere can see within\
      ...
      \ has the [Unconscious](/Rules/Source/conditions.md#Unconscious) condition for\
      \ 10 minutes or until it takes damage or a creature within 5 feet of it takes\
      \ an action to wake it. *Success:* The target is immune to this jackalwere's\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fiend/token/jackalwere-xmm.webp"
```{ #statblock}
