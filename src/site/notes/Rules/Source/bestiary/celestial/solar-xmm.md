...
"traits":
  ...
  - "desc": "If the solar dies outside Mount Celestia, its body disappears, and it\
      \ gains a new body instantly, reviving with all its [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ somewhere in Mount Celestia."
    "name": "Exalted Restoration"
  - "desc": "If the solar fails a saving throw, it can choose to succeed instead."
    "name": "Legendary Resistance (4/Day)"
  - "desc": "The solar has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 21, one creature the solar can see within\
      \ 600 feet. *Failure:* If the creature has 100 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The solar casts one of the following spells, requiring no Material components\
      ...
      \ [Resurrection](/Rules/Source/spells/resurrection-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The solar casts [Cure Wounds](/Rules/Source/spells/cure-wounds-xphb.md)\
      \ (level 2 version), [Lesser Restoration](/Rules/Source/spells/lesser-restoration-xphb.md),\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 25, one creature the solar can see within\
      \ 120 feet. *Failure:* The target has the [Blinded](/Rules/Source/conditions.md#Blinded)\
  ...
  - "desc": "The solar teleports up to 60 feet to an unoccupied space it can see.\
      \ *Dexterity Saving Throw:* DC 25, each creature in a 10-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/celestial/token/solar-xmm.webp"
```{ #statblock}
