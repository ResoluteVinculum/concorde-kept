---
{"dg-publish":true,"permalink":"/rules/source/bestiary/celestial/deva-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/upper","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/celestial/angel"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/upper","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/celestial/angel"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Deva"]}}
---

# [Deva](Rules\Source\bestiary\celestial/deva-xmm.md)
...
"traits":
  ...
  - "desc": "The deva has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The deva casts one of the following spells, requiring no Material components\
      ...
      \ required to maintain the spell)\n\n**1/day each:** [Commune](/Rules/Source/spells/commune-xphb.md),\
      \ [Raise Dead](/Rules/Source/spells/raise-dead-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The deva casts [Cure Wounds](/Rules/Source/spells/cure-wounds-xphb.md),\
      \ [Lesser Restoration](/Rules/Source/spells/lesser-restoration-xphb.md), or\
      \ [Remove Curse](/Rules/Source/spells/remove-curse-xphb.md), using the same\
      \ spellcasting ability as Spellcasting.\n"
    "name": "Divine Aid (2/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/celestial/token/deva-xmm.webp"
```{ #statblock}
