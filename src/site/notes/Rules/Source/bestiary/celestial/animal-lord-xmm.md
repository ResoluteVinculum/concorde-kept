...
"traits":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot\
      ...
      \ [Charmed](/Rules/Source/conditions.md#Charmed) condition until the end of\
      \ its next turn. While [Charmed](/Rules/Source/conditions.md#Charmed), the target\
      \ has the [Incapacitated](/Rules/Source/conditions.md#Incapacitated) condition.\
      \  \n- **Fearful (Hunter Only).** The target has the [Frightened](/Rules/Source/conditions.md#Frightened)\
  ...
  - "desc": "The animal lord has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The animal lord conjures an animal spirit that strikes at a creature\
      ...
      - **Fortify (Forager Only).** The animal lord gains 20 [Temporary Hit Points](/Rules/Source/variant-rules/temporary-hit-points-xphb.md).\
      \  \n- **Marked as Prey (Hunter Only).** The animal lord has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ on attack rolls against the target until the start of the animal lord's next\
      \ turn.  \n- **Pesky Swarm (Sage Only).** The target has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
  ...
  - "desc": "The animal lord casts one of the following spells, requiring no Material\
      ...
      \ [Animal Messenger](/Rules/Source/spells/animal-messenger-xphb.md), [Speak\
      \ with Animals](/Rules/Source/spells/speak-with-animals-xphb.md)\n\n**2/day\
      \ each:** [Awaken](/Rules/Source/spells/awaken-xphb.md), [Greater Restoration](/Rules/Source/spells/greater-restoration-xphb.md)\n\
      \n**1/day each:** [Animal Shapes](/Rules/Source/spells/animal-shapes-xphb.md),\
      \ [Sunburst](/Rules/Source/spells/sunburst-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"legendary_actions":
  - "desc": "The animal lord moves up to its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/celestial/token/animal-lord-xmm.webp"
```{ #statblock}
