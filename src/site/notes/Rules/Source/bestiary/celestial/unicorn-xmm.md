...
"traits":
  ...
  - "desc": "The unicorn has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The unicorn casts one of the following spells, requiring no spell components\
      ...
      \ [Druidcraft](/Rules/Source/spells/druidcraft-xphb.md)\n\n**1/day each:** [Calm\
      \ Emotions](/Rules/Source/spells/calm-emotions-xphb.md), [Dispel Evil and Good](/Rules/Source/spells/dispel-evil-and-good-xphb.md),\
      \ [Entangle](/Rules/Source/spells/entangle-xphb.md), [Pass without Trace](/Rules/Source/spells/pass-without-trace-xphb.md),\
      \ [Word of Recall](/Rules/Source/spells/word-of-recall-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The unicorn touches another creature with its horn and casts [Cure Wounds](/Rules/Source/spells/cure-wounds-xphb.md)\
      \ or [Lesser Restoration](/Rules/Source/spells/lesser-restoration-xphb.md) on\
...
"regional_effects":
  - "desc": "The region containing a unicorn's lair is changed by its presence, creating\
      ...
      \ have [Advantage](/Rules/Source/variant-rules/advantage-xphb.md) on Dexterity\
      \ ([Stealth](/Rules/Source/skills.md#Stealth)) checks while within 1 mile of\
      \ the lair.  \n- **Positive Energy.** Whenever a creature within 1 mile of the\
      \ lair regains [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ from a spell, it regains the maximum number of [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
...
"legendary_actions":
  - "desc": "The unicorn moves up to half its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
  ...
  - "desc": "The unicorn targets itself or one creature it can see within 60 feet\
      \ of itself. The target gains 10 (3d6) [Temporary Hit Points](/Rules/Source/variant-rules/temporary-hit-points-xphb.md),\
      \ and its AC increases by 2 until the end of the unicorn's next turn. The unicorn\
      \ can't take this action again until the start of its next turn."
    "name": "Shimmering Shield"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/celestial/token/unicorn-xmm.webp"
```{ #statblock}
