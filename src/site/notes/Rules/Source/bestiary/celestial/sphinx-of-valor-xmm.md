...
"actions":
  ...
  - "desc": "The sphinx emits a magical roar. Whenever it roars, the roar has a different\
      \ effect, as detailed below (the sequence resets when it takes a [Long Rest](/Rules/Source/variant-rules/long-rest-xphb.md)):\n\
      \n- **First Roar.** *Wisdom Saving Throw:* DC 20, each enemy in a 500-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. *Failure:* The target has the [Frightened](/Rules/Source/conditions.md#Frightened)\
      \ condition for 1 minute.  \n- **Second Roar.** *Wisdom Saving Throw:* DC 20,\
      \ each enemy in a 500-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. *Failure:* The target has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed)\
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      \ [Greater Restoration](/Rules/Source/spells/greater-restoration-xphb.md), [Heroes'\
      \ Feast](/Rules/Source/spells/heroes-feast-xphb.md), [Zone of Truth](/Rules/Source/spells/zone-of-truth-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing a sphinx of lore's or sphinx of valor's lair is\
      ...
      \ While in its lair, the sphinx can cast [Clairvoyance](/Rules/Source/spells/clairvoyance-xphb.md),\
      ...
      \ a [Study](/Rules/Source/actions.md#Study) action while within 1 mile of the\
      \ lair, it adds 1d6 to any ability check it makes for that action.  \n\nIf the\
      \ sphinx dies or moves its lair elsewhere, these effects end immediately."
    "name": ""
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 16, one creature the sphinx can see within\
      \ 120 feet. *Failure:* The target gains 1 [Exhaustion](/Rules/Source/conditions.md#Exhaustion)\
      \ level. While the target has any [Exhaustion](/Rules/Source/conditions.md#Exhaustion)\
      \ levels, it appears 3d10 years older. *Failure or Success:* The sphinx can't\
      \ take this action again until the start of its next turn."
    "name": "Weight of Years"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/celestial/token/sphinx-of-valor-xmm.webp"
```{ #statblock}
