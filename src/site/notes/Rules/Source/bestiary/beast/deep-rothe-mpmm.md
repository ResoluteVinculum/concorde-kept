---
{"dg-publish":true,"permalink":"/rules/source/bestiary/beast/deep-rothe-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-4","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/beast/cattle"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/1-4","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/beast/cattle"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Deep Rothé"]}}
---

# [Deep Rothé](Rules\Source\bestiary\beast/deep-rothe-mpmm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 7 (1d6\
      ...
      \ damage."
    "name": "Gore"
  - "desc": "The rothé casts [dancing lights](/Rules/Source/spells/dancing-lights-xphb.md),\
      \ requiring no spell components and using Wisdom as the spellcasting ability.\n"
    "name": "Dancing Lights"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/beast/token/deep-rothe-mpmm.webp"
```{ #statblock}
