...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 10 (2d6 + 3) Bludgeoning\
      ...
      \ the [Grappled](/Rules/Source/conditions.md#Grappled) condition (escape DC\
      \ 13) instead of dealing damage. Until the grapple ends, the target has the\
      \ [Blinded](/Rules/Source/conditions.md#Blinded) and [Restrained](/Rules/Source/conditions.md#Restrained)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/construct/token/animated-rug-of-smothering-xmm.webp"
```{ #statblock}
