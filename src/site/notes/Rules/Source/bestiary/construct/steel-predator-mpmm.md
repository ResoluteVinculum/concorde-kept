---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/steel-predator-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/16","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/construct"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/16","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/construct"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Steel Predator"]}}
---

# [Steel Predator](Rules\Source\bestiary\construct/steel-predator-mpmm.md)
...
"actions":
  ...
  - "desc": "The steel predator emits a roar in a 60-foot cone. Each creature in that\
      ...
      \ takes 33 (6d10) thunder damage, drops everything it's holding, and is [stunned](/Rules/Source/conditions.md#Stunned)\
      \ for 1 minute. The [stunned](/Rules/Source/conditions.md#Stunned) creature\
      \ can repeat the saving throw at the end of each of its turns, ending the effect\
      \ on itself on a success. On a successful save, a creature takes half as much\
      \ damage and isn't [stunned](/Rules/Source/conditions.md#Stunned)."
    "name": "Stunning Roar (Recharge 5-6)"
  - "desc": "The steel predator casts one of the following spells, requiring no spell\
      \ components and using Wisdom as the spellcasting ability:\n\n**3/day each:**\
      \ [dimension door](/Rules/Source/spells/dimension-door-xphb.md) (self only),\
      \ [plane shift](/Rules/Source/spells/plane-shift-xphb.md) (self only)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/construct/token/steel-predator-mpmm.webp"
```{ #statblock}
