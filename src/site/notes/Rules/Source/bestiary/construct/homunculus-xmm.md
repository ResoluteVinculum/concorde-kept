---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/homunculus-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/0","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/tiny","ttrpg-cli/monster/type/construct"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/0","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/tiny","ttrpg-cli/monster/type/construct"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Homunculus"]}}
---

# [Homunculus](Rules\Source\bestiary\construct/homunculus-xmm.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 1 Piercing damage, and the\
      ...
      \ DC 12. *Failure:* The target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      ...
      \ for 1 minute. While [Poisoned](/Rules/Source/conditions.md#Poisoned), the\
      \ target has the [Unconscious](/Rules/Source/conditions.md#Unconscious) condition,\
      \ which ends early if the target takes any damage."
    "name": "Bite"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/construct/token/homunculus-xmm.webp"
```{ #statblock}
