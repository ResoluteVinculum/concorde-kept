---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/animated-broom-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-4","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/construct"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-4","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/construct"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Animated Broom"]}}
---

# [Animated Broom](Rules\Source\bestiary\construct/animated-broom-xmm.md)
...
"cr": "1/4"
"traits":
  - "desc": "The broom doesn't provoke an [Opportunity Attack](/Rules/Source/actions.md#Opportunity%20Attack)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/construct/token/animated-broom-xmm.webp"
```{ #statblock}
