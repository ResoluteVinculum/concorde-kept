...
"traits":
  - "desc": "Whenever the golem is subjected to Fire damage, it regains a number of\
      \ [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md) equal to the\
      \ Fire damage dealt."
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/construct/token/iron-golem-xmm.webp"
```{ #statblock}
