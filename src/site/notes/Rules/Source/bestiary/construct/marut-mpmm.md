---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/marut-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/25","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/construct/inevitable"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/25","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/construct/inevitable"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Marut"]}}
---

# [Marut](Rules\Source\bestiary\construct/marut-mpmm.md)
...
"actions":
  ...
  - "desc": "Arcane energy emanates from the marut's chest in a 60-foot cube. Every\
      ...
      \ of this damage must succeed on a DC 20 Wisdom saving throw or be [stunned](/Rules/Source/conditions.md#Stunned)\
      \ until the end of the marut's next turn."
    "name": "Blazing Edict (Recharge 5-6)"
  - "desc": "The marut casts [plane shift](/Rules/Source/spells/plane-shift-xphb.md),\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/construct/token/marut-mpmm.webp"
```
^statblock