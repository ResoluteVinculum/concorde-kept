---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/brazen-gorgon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/9","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/construct"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/9","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/construct"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Brazen Gorgon"]}}
---

# [Brazen Gorgon](Rules\Source\bestiary\construct/brazen-gorgon-xmm.md)
...
"cr": "9"
"traits":
  - "desc": "At the end of each of the gorgon's turns, each creature in a 5-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the gorgon takes 13 (3d8) Fire damage."
    "name": "Flame Aura"
  - "desc": "The gorgon sheds [Bright Light](/Rules/Source/variant-rules/bright-light-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 5 ft. *Hit:* 11 (2d6 + 4) Piercing damage\
    ...
    "name": "Gore"
  - "desc": "The gorgon moves up to its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      ...
      \ and the target is pulled into the gorgon's space and has the [Grappled](/Rules/Source/conditions.md#Grappled)\
      \ condition (escape DC 14); if the gorgon already has a creature [Grappled](/Rules/Source/conditions.md#Grappled),\
      \ the target has the [Prone](/Rules/Source/conditions.md#Prone) condition instead.\
      \ Until the grapple ends, the target has the [Restrained](/Rules/Source/conditions.md#Restrained)\
      \ condition. When the gorgon moves, the [Grappled](/Rules/Source/conditions.md#Grappled)\
      \ target moves with it, costing no extra movement."
    "name": "Smelting Charge (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/construct/token/brazen-gorgon-xmm.webp"
```{ #statblock}
