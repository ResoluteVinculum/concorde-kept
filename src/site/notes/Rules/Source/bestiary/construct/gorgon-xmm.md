...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 15, each creature in a 30-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *1St Failure:* The target has the [Restrained](/Rules/Source/conditions.md#Restrained)\
...
"bonus_actions":
  - "desc": "*Dexterity Saving Throw:* DC 16, one creature within 5 feet that has\
      \ the [Prone](/Rules/Source/conditions.md#Prone) condition. *Failure:* 16 (2d10\
      \ + 5) Bludgeoning damage. *Success:* Half damage."
    "name": "Trample"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/construct/token/gorgon-xmm.webp"
```{ #statblock}
