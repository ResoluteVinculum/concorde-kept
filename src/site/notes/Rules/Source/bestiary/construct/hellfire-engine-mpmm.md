---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/hellfire-engine-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/16","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/construct"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/16","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/construct"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Hellfire Engine"]}}
---

# [Hellfire Engine](Rules\Source\bestiary\construct/hellfire-engine-mpmm.md)
...
"actions":
  - "desc": "The hellfire engine moves up to its speed in a straight line. During\
      ...
      \ hellfire engine's path. On a failed save, the creature falls [prone](/Rules/Source/conditions.md#Prone)\
      \ and takes 28 (8d6) bludgeoning damage.\n\nIf the hellfire engine remains in\
      \ the [prone](/Rules/Source/conditions.md#Prone) creature's space, the creature\
      \ is also [restrained](/Rules/Source/conditions.md#Restrained) until it's no\
      \ longer in the same space as the hellfire engine. While [restrained](/Rules/Source/conditions.md#Restrained)\
  ...
  - "desc": "The hellfire engine uses one of the following options (choose one or\
      ...
      \ kills a creature, the creature's soul rises from the River Styx as a [lemure](/Rules/Source/bestiary/fiend/lemure-xmm.md)\
      \ in Avernus in 1d4 hours. If the creature isn't revived before then, only a\
      \ [wish](/Rules/Source/spells/wish-xphb.md) spell or killing the [lemure](/Rules/Source/bestiary/fiend/lemure-xmm.md)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/construct/token/hellfire-engine-mpmm.webp"
```
^statblock