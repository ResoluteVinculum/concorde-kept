...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 6 (1d6\
      ...
      \ creature is visible within 30 feet, it takes the [Dash](/Rules/Source/actions.md#Dash)\
      \ action, moving toward the nearest creature.  \n- **3–4 Paralysis.** The target\
      \ is [paralyzed](/Rules/Source/conditions.md#Paralyzed) until the end of its\
      \ next turn.  \n- **5–6 Poison.** The target takes 13 (3d8) poison damage.  "
    "name": "Bite"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/construct/token/clockwork-iron-cobra-mpmm.webp"
```{ #statblock}
