---
{"dg-publish":true,"permalink":"/rules/source/bestiary/construct/duergar-screamer-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/construct/dwarf"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/3","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/construct/dwarf"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Duergar Screamer"]}}
---

# [Duergar Screamer](Rules\Source\bestiary\construct/duergar-screamer-mpmm.md)
...
"actions":
  ...
  - "desc": "The screamer emits destructive energy in a 15-foot cube. Each creature\
      ...
      \ thunder damage and be knocked [prone](/Rules/Source/conditions.md#Prone)."
    "name": "Sonic Scream"
"reactions":
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/construct/token/duergar-screamer-mpmm.webp"
```{ #statblock}
