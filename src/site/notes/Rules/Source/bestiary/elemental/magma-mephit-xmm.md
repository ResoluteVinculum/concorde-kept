...
"actions":
  - "desc": "*Melee Attack Roll:* +3, reach 5 ft. *Hit:* 3 (1d4 + 1) Slashing damage\
    ...
    "name": "Claw"
  - "desc": "*Dexterity Saving Throw:* DC 11, each creature in a 15-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 7 (2d6) Fire damage. *Success:* Half damage."
    "name": "Fire Breath (Recharge 6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/magma-mephit-xmm.webp"
```{ #statblock}
