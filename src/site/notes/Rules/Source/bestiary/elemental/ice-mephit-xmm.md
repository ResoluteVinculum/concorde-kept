...
"actions":
  ...
  - "desc": "The mephit casts [Fog Cloud](/Rules/Source/spells/fog-cloud-xphb.md),\
      \ requiring no spell components and using Charisma as the spellcasting ability.\n"
    "name": "Fog Cloud (1/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/ice-mephit-xmm.webp"
```{ #statblock}
