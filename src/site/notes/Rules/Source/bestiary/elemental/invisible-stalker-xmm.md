---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/invisible-stalker-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Invisible Stalker"]}}
---

# [Invisible Stalker](Rules\Source\bestiary\elemental/invisible-stalker-xmm.md)
...
"traits":
  - "desc": "The stalker can enter an enemy's space and stop there. It can move through\
    ...
    "name": "Air Form"
  - "desc": "The stalker has the [Invisible](/Rules/Source/conditions.md#Invisible)\
      \ condition."
    "name": "Invisibility"
"actions":
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/invisible-stalker-xmm.webp"
```{ #statblock}
