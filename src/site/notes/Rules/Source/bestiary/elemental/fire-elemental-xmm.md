---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/fire-elemental-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/fire","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/fire","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Fire Elemental"]}}
---

# [Fire Elemental](Rules\Source\bestiary\elemental/fire-elemental-xmm.md)
...
"traits":
  - "desc": "At the end of each of the elemental's turns, each creature in a 10-foot\
      ...
      \ objects in the [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ start [burning](/Rules/Source/traps-hazards/burning-xphb.md)."
    "name": "Fire Aura"
  - "desc": "The elemental can move through a space as narrow as 1 inch without expending\
      ...
      \ 5 (1d10) Fire damage."
    "name": "Fire Form"
  - "desc": "The elemental sheds [Bright Light](/Rules/Source/variant-rules/bright-light-xphb.md)\
      \ in a 30-foot radius and [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 10 (2d6 + 3) Fire damage.\
      \ If the target is a creature or a flammable object, it starts [burning](/Rules/Source/traps-hazards/burning-xphb.md)."
    "name": "Burn"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/fire-elemental-xmm.webp"
```{ #statblock}
