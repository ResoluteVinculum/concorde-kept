---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/xorn-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/earth","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/elemental"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/earth","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Xorn"]}}
---

# [Xorn](Rules\Source\bestiary\elemental/xorn-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 8 (1d10 + 3) Slashing damage."
    "name": "Claw"
"bonus_actions":
  - "desc": "The xorn moves up to its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ or [Burrow Speed](/Rules/Source/variant-rules/burrow-speed-xphb.md) straight\
      \ toward an enemy it can sense."
    "name": "Charge"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/xorn-xmm.webp"
```{ #statblock}
