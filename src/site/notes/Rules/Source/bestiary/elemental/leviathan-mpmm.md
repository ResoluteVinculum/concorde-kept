---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/leviathan-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/20","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/elemental"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/20","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Leviathan"]}}
---

# [Leviathan](Rules\Source\bestiary\elemental/leviathan-mpmm.md)
...
"actions":
  ...
  - "desc": "The leviathan magically creates a wave of water that extends from a point\
      ...
      \ bludgeoning damage and is knocked [prone](/Rules/Source/conditions.md#Prone).\
      \ On a successful save, a creature takes half as much damage and isn't knocked\
      \ [prone](/Rules/Source/conditions.md#Prone). The water spreads out across the\
      \ ground in all directions, extinguishing unprotected flames in its area and\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/elemental/token/leviathan-mpmm.webp"
```{ #statblock}
