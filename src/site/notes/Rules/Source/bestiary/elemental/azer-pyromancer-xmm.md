...
"traits":
  - "desc": "At the end of each of the azer's turns, each creature of the azer's choice\
      ...
      \ the [Incapacitated](/Rules/Source/conditions.md#Incapacitated) condition."
    "name": "Fire Aura"
...
"actions":
  ...
  - "desc": "The azer casts one of the following spells, requiring no Material components\
      ...
      \ [Elementalism](/Rules/Source/spells/elementalism-xphb.md), [Mage Hand](/Rules/Source/spells/mage-hand-xphb.md)\n\
      \n**1/day:** [Fireball](/Rules/Source/spells/fireball-xphb.md)"
    "name": "Spellcasting"
"reactions":
  - "desc": "The azer casts [Hellish Rebuke](/Rules/Source/spells/hellish-rebuke-xphb.md)\
      \ in response to that spell's trigger, using the same spellcasting ability as\
      \ Spellcasting.\n"
    "name": "Hellish Rebuke (2/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/azer-pyromancer-xmm.webp"
```{ #statblock}
