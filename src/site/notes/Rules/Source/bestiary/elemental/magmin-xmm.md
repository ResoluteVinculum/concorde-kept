...
"traits":
  - "desc": "The magmin explodes when it dies. *Dexterity Saving Throw:* DC 11, each\
      \ creature in a 10-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 7 (2d4 + 2) Fire damage.\
      ...
      \ carried, it starts [burning](/Rules/Source/traps-hazards/burning-xphb.md)."
    "name": "Touch"
"bonus_actions":
  - "desc": "The magmin sets itself ablaze or extinguishes its flames. While ablaze,\
      \ the magmin sheds [Bright Light](/Rules/Source/variant-rules/bright-light-xphb.md)\
      \ in a 10-foot radius and [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md)\
      \ for an additional 10 feet."
    "name": "Ignited Illumination"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/magmin-xmm.webp"
```{ #statblock}
