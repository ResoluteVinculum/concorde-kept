---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/elder-tempest-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/23","ttrpg-cli/monster/environment/arctic","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/elemental"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/23","ttrpg-cli/monster/environment/arctic","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Elder Tempest"]}}
---

# [Elder Tempest](Rules\Source\bestiary\elemental/elder-tempest-mpmm.md)
...
"traits":
  - "desc": "The tempest can enter a hostile creature's space and stop there. It can\
    ...
    "name": "Air Form"
  - "desc": "The tempest doesn't provoke [opportunity attacks](/Rules/Source/actions.md#Opportunity%20Attack)\
  ...
  - "desc": "The tempest is always at the center of a storm 1d6 + 4 miles in diameter.\
      ...
      \ and imposes disadvantage on Wisdom ([Perception](/Rules/Source/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "Each creature within 120 feet of the tempest must make a DC 21 Dexterity\
      ...
      \ more, the creature is also [stunned](/Rules/Source/conditions.md#Stunned)\
...
"legendary_actions":
  ...
  - "desc": "The tempest releases a blast of thunder and wind in a line that is 300\
      ...
      \ throw or take the same impact damage and be knocked [prone](/Rules/Source/conditions.md#Prone)."
    "name": "Screaming Gale (Costs 3 Actions)"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/elemental/token/elder-tempest-mpmm.webp"
```{ #statblock}
