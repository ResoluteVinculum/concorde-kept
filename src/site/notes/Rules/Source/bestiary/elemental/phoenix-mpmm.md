...
"traits":
  ...
  - "desc": "The phoenix can move through a space as narrow as 1 inch wide without\
    ...
    "name": "Fire Form"
  - "desc": "The phoenix doesn't provoke [opportunity attacks](/Rules/Source/actions.md#Opportunity%20Attack)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/elemental/token/phoenix-mpmm.webp"
```{ #statblock}
