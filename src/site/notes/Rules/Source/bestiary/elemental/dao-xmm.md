---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/dao-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/earth","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental/genie"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/earth","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental/genie"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Dao"]}}
---

# [Dao](Rules\Source\bestiary\elemental/dao-xmm.md)
...
"traits":
  ...
  - "desc": "The dao has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "The dao has a 30 percent chance of knowing the [Wish](/Rules/Source/spells/wish-xphb.md)\
...
"actions":
  ...
  - "desc": "The dao casts one of the following spells, requiring no Material components\
      ...
      \ [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Stone Shape](/Rules/Source/spells/stone-shape-xphb.md)\n\
      \n**1/day each:** [Gaseous Form](/Rules/Source/spells/gaseous-form-xphb.md),\
      \ [Invisibility](/Rules/Source/spells/invisibility-xphb.md), [Move Earth](/Rules/Source/spells/move-earth-xphb.md),\
      \ [Passwall](/Rules/Source/spells/passwall-xphb.md), [Plane Shift](/Rules/Source/spells/plane-shift-xphb.md),\
      \ [Tongues](/Rules/Source/spells/tongues-xphb.md), [Wall of Stone](/Rules/Source/spells/wall-of-stone-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/dao-xmm.webp"
```{ #statblock}
