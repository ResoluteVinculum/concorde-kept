...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 4 (1d4 + 2) Slashing damage."
    "name": "Claw"
  - "desc": "*Dexterity Saving Throw:* DC 10, each creature in a 15-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target has the [Blinded](/Rules/Source/conditions.md#Blinded)\
      \ condition until the end of the mephit's next turn."
    "name": "Blinding Breath (Recharge 6)"
  - "desc": "The mephit casts the [Sleep](/Rules/Source/spells/sleep-xphb.md) spell,\
      \ requiring no spell components and using Charisma as the spellcasting ability\
      \ (spell save DC 10).\n"
    "name": "Sleep (1/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/dust-mephit-xmm.webp"
```{ #statblock}
