---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/merfolk-skirmisher-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-8","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/elemental"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-8","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/elemental"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Merfolk Skirmisher"]}}
---

# [Merfolk Skirmisher](Rules\Source\bestiary\elemental/merfolk-skirmisher-xmm.md)
...
"actions":
  - "desc": "*Melee  or Ranged Attack Roll:* +2, reach 5 ft. or range 20/60 ft. *Hit:*\
      ...
      \ its [Speed](/Rules/Source/variant-rules/speed-xphb.md) decreases by 10 feet\
      \ until the end of its next turn. *Hit or Miss:* The spear magically returns\
      \ to the merfolk's hand immediately after a ranged attack."
    "name": "Ocean Spear"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/merfolk-skirmisher-xmm.webp"
```{ #statblock}
