---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/elemental-cataclysm-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/22","ttrpg-cli/monster/environment/elemental-chaos","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/elemental/titan"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/22","ttrpg-cli/monster/environment/elemental-chaos","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/elemental/titan"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Elemental Cataclysm"]}}
---

# [Elemental Cataclysm](Rules\Source\bestiary\elemental/elemental-cataclysm-xmm.md)
...
"senses": "[Truesight](/Rules/Source/senses.md#Truesight) 150 ft., passive Perception\
  \ 12"
...
"actions":
  ...
  - "desc": "The cataclysm creates one of the following effects at random (roll 1d4):\n\
      ...
      \ a 60-foot-radius [Sphere](/Rules/Source/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ Waves.** *Strength Saving Throw:* DC 23, each creature in a 90-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 22 (5d8) Bludgeoning damage plus 22 (5d8) Cold damage, and the\
      \ target has the [Prone](/Rules/Source/conditions.md#Prone) condition. *Success:*\
      \ Half damage only. *Failure or Success:* The target's [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ is reduced to 0 until the end of its next turn.  \n- **3 Raging Storm.** A\
      \ storm cloud fills a 60-foot-radius [Sphere](/Rules/Source/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ entirely in the cloud have the [Blinded](/Rules/Source/conditions.md#Blinded)\
      \ and [Deafened](/Rules/Source/conditions.md#Deafened) conditions and can't\
      ...
      \ DC 23, each creature in a 90-foot [Cube](/Rules/Source/variant-rules/cube-area-of-effect-xphb.md)\
      \ originating from a point on the ground within 150 feet. *Failure:* 18 (4d8)\
      \ Bludgeoning damage plus 18 (4d8) Acid damage, and the target has the [Prone](/Rules/Source/conditions.md#Prone)\
      \ condition and is buried under rubble. A buried target has the [Restrained](/Rules/Source/conditions.md#Restrained)\
      \ condition, has [Total Cover](/Rules/Source/variant-rules/cover-xphb.md), and\
      \ is suffocating. As an action, a buried creature or another creature within\
      \ 5 feet of it can make a DC 18 Strength ([Athletics](/Rules/Source/skills.md#Athletics))\
      \ check. On a successful check, the creature is no longer buried. *Success:*\
      \ Half damage only.  "
    "name": "Cataclysmic Event (Recharge 4-6)"
  - "desc": "The cataclysm casts the [Control Weather](/Rules/Source/spells/control-weather-xphb.md)\
...
"legendary_actions":
  - "desc": "The cataclysm makes one Elemental Burst attack."
    "name": "Eruption"
  - "desc": "The cataclysm moves up to its [Speed](/Rules/Source/variant-rules/speed-xphb.md),\
      \ [Fly Speed](/Rules/Source/variant-rules/fly-speed-xphb.md), or [Swim Speed](/Rules/Source/variant-rules/swim-speed-xphb.md)\
      ...
      \ target has the [Prone](/Rules/Source/conditions.md#Prone) condition. *Failure\
      \ or Success:* The cataclysm can't take this action again until the start of\
      \ its next turn."
    "name": "Rumbling Movement"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/elemental-cataclysm-xmm.webp"
```{ #statblock}
