...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 13, one Medium or smaller creature in the\
      ...
      \ is pushed up to 20 feet straight away from the elemental and has the [Prone](/Rules/Source/conditions.md#Prone)\
      \ condition. *Success:* Half damage only."
    "name": "Whirlwind (Recharge 4-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/air-elemental-xmm.webp"
```{ #statblock}
