---
{"dg-publish":true,"permalink":"/rules/source/bestiary/elemental/marid-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/environment/water","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental/genie"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/environment/water","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/elemental/genie"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Marid"]}}
---

# [Marid](Rules\Source\bestiary\elemental/marid-xmm.md)
...
"traits":
  ...
  - "desc": "The marid has a 30 percent chance of knowing the [Wish](/Rules/Source/spells/wish-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 60-foot-long, 10-foot-wide\
      ...
      \ up to 20 feet straight away from the marid and has the [Prone](/Rules/Source/conditions.md#Prone)\
      \ condition. *Success:* Half damage only."
    "name": "Water Jet"
  - "desc": "The marid casts one of the following spells, requiring no Material components\
      \ and using Charisma as the spellcasting ability (spell save DC 16):\n\n**At\
      \ will:** [Create or Destroy Water](/Rules/Source/spells/create-or-destroy-water-xphb.md),\
      \ [Detect Evil and Good](/Rules/Source/spells/detect-evil-and-good-xphb.md),\
      \ [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Purify Food and\
      \ Drink](/Rules/Source/spells/purify-food-and-drink-xphb.md)\n\n**1/day each:**\
      \ [Control Water](/Rules/Source/spells/control-water-xphb.md), [Gaseous Form](/Rules/Source/spells/gaseous-form-xphb.md),\
      \ [Invisibility](/Rules/Source/spells/invisibility-xphb.md), [Plane Shift](/Rules/Source/spells/plane-shift-xphb.md),\
      \ [Tongues](/Rules/Source/spells/tongues-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The marid casts [Fog Cloud](/Rules/Source/spells/fog-cloud-xphb.md),\
      \ using the same spellcasting ability as Spellcasting.\n"
    "name": "Misty Veil (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/elemental/token/marid-xmm.webp"
```{ #statblock}
