---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/ancient-red-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/24","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/chromatic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/24","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/chromatic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ancient Red Dragon"]}}
---

# [Ancient Red Dragon](Rules\Source\bestiary\dragon/ancient-red-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Scorching Ray](/Rules/Source/spells/scorching-ray-xphb.md)\
      \ (level 3 version)."
    "name": "Multiattack"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ with spell attacks):\n\n**At will:** [Command](/Rules/Source/spells/command-xphb.md)\
      \ (level 2 version), [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md),\
      \ [Scorching Ray](/Rules/Source/spells/scorching-ray-xphb.md) (level 3 version)\n\
      \n**1/day each:** [Fireball](/Rules/Source/spells/fireball-xphb.md) (level 6\
      \ version), [Scrying](/Rules/Source/spells/scrying-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient red dragon's lair is warped\
      ...
      \ Obscured](/Rules/Source/variant-rules/lightly-obscured-xphb.md) with clouds\
      \ of ash. Whenever a creature other than the dragon or one of its allies finishes\
      \ a [Long Rest](/Rules/Source/variant-rules/long-rest-xphb.md) in that area,\
      \ that creature must succeed on a DC 15 Constitution saving throw or have the\
      \ [Poisoned](/Rules/Source/conditions.md#Poisoned) condition for 1 hour.  \n\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Command](/Rules/Source/spells/command-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/ancient-red-dragon-xmm.webp"
```{ #statblock}
