---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/shadow-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/shadowfell","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/environment/shadowfell","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Shadow Dragon"]}}
---

# [Shadow Dragon](Rules\Source\bestiary\dragon/shadow-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 10 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 17, each creature in a 60-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 35 (10d6) Necrotic damage. *Success:* Half damage. *Failure or\
      \ Success:* A Humanoid reduced to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
...
"regional_effects":
  - "desc": "The region around a shadow dragon's lair is twisted by its presence,\
      ...
      \ normally create [Bright Light](/Rules/Source/variant-rules/bright-light-xphb.md)\
      \ instead create [Dim Light](/Rules/Source/variant-rules/dim-light-xphb.md),\
      \ and creatures there have [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ on Dexterity ([Stealth](/Rules/Source/skills.md#Stealth)) checks.  \n\nIf\
      \ the dragon dies or moves its lair elsewhere, these effects end immediately."
    "name": ""
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/shadow-dragon-xmm.webp"
```{ #statblock}
