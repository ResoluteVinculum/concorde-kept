---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/ancient-brass-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/20","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/metallic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/20","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/metallic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ancient Brass Dragon"]}}
---

# [Ancient Brass Dragon](Rules\Source\bestiary\dragon/ancient-brass-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 21, each creature in a 90-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 3 version), [Shapechange](/Rules/Source/spells/shapechange-xphb.md)\
      ...
      \ [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
...
"legendary_actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 20, one creature the dragon can see within\
      \ 120 feet. *Failure:* 36 (8d8) Fire damage, and the target's [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ is halved until the end of its next turn. *Failure or Success:* The dragon\
      \ can't take this action again until the start of its next turn."
    "name": "Scorching Sands"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/ancient-brass-dragon-xmm.webp"
```{ #statblock}
