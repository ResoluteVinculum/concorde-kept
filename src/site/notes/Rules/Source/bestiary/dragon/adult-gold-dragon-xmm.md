---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/adult-gold-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/metallic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/metallic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Adult Gold Dragon"]}}
---

# [Adult Gold Dragon](Rules\Source\bestiary\dragon/adult-gold-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +14, reach 10 ft. *Hit:* 17 (2d8 + 8) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 21, each creature in a 60-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "*Strength Saving Throw:* DC 21, each creature that isn't currently affected\
      \ by this breath in a 60-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 21, one creature the dragon can see within\
      \ 120 feet. *Failure:* 10 (3d6) Force damage, and the target has the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/adult-gold-dragon-xmm.webp"
```{ #statblock}
