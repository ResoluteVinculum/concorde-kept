---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/dragon-turtle-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Dragon Turtle"]}}
---

# [Dragon Turtle](Rules\Source\bestiary\dragon/dragon-turtle-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +13, reach 15 ft. *Hit:* 23 (3d10 + 7) Piercing\
      \ damage plus 7 (2d6) Fire damage. Being underwater doesn't grant [Resistance](/Rules/Source/variant-rules/resistance-xphb.md)\
      \ to this Fire damage."
    "name": "Bite"
  - "desc": "*Melee Attack Roll:* +13, reach 15 ft. *Hit:* 18 (2d10 + 7) Bludgeoning\
      ...
      \ condition."
    "name": "Tail"
  - "desc": "*Constitution Saving Throw:* DC 19, each creature in a 60-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 56 (16d6) Fire damage. *Success:* Half damage. *Failure or Success:*\
      \ Being underwater doesn't grant [Resistance](/Rules/Source/variant-rules/resistance-xphb.md)\
      \ to this Fire damage."
    "name": "Steam Breath (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/dragon-turtle-xmm.webp"
```{ #statblock}
