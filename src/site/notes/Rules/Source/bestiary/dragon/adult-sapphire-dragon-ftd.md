---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/adult-sapphire-dragon-ftd/","tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/15","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/gem"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/ftd","ttrpg-cli/monster/cr/15","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/gem"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Adult Sapphire Dragon"]}}
---
...
| 8 | An adult sapphire dragon and an aboleth psychically face off for control of an area of the Underdark. The constant bombardment of psychic forces has begun to affect the local fauna in strange ways. |{ #connected-creatures}
