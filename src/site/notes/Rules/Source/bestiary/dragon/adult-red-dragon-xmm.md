...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Scorching Ray](/Rules/Source/spells/scorching-ray-xphb.md)\n\n**1/day:**\
      \ [Fireball](/Rules/Source/spells/fireball-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/adult-red-dragon-xmm.webp"
```{ #statblock}
