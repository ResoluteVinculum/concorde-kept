---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/ancient-green-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/22","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/chromatic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/22","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/chromatic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ancient Green Dragon"]}}
---

# [Ancient Green Dragon](Rules\Source\bestiary\dragon/ancient-green-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Mind Spike](/Rules/Source/spells/mind-spike-xphb.md)\
      \ (level 5 version)."
    "name": "Multiattack"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 5 version)\n\n**1/day each:** [Geas](/Rules/Source/spells/geas-xphb.md),\
      \ [Modify Memory](/Rules/Source/spells/modify-memory-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient green dragon's lair is warped\
      ...
      \ it must succeed on a DC 15 Constitution saving throw or have the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/ancient-green-dragon-xmm.webp"
```{ #statblock}
