---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/adult-blue-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/16","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/chromatic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/16","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/chromatic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Adult Blue Dragon"]}}
---

# [Adult Blue Dragon](Rules\Source\bestiary\dragon/adult-blue-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Shatter](/Rules/Source/spells/shatter-xphb.md)."
    "name": "Multiattack"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Magic](/Rules/Source/spells/detect-magic-xphb.md), [Invisibility](/Rules/Source/spells/invisibility-xphb.md),\
      \ [Mage Hand](/Rules/Source/spells/mage-hand-xphb.md), [Shatter](/Rules/Source/spells/shatter-xphb.md)\n\
      \n**1/day each:** [Scrying](/Rules/Source/spells/scrying-xphb.md), [Sending](/Rules/Source/spells/sending-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient blue dragon's lair is changed\
      ...
      \ in that area other than the dragon and its allies finishes a [Long Rest](/Rules/Source/variant-rules/long-rest-xphb.md),\
      ...
      \ within 1 mile of the lair. The area is [Lightly Obscured](/Rules/Source/variant-rules/lightly-obscured-xphb.md).\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Invisibility](/Rules/Source/spells/invisibility-xphb.md)\
      \ on itself, and it can fly up to half its [Fly Speed](/Rules/Source/variant-rules/fly-speed-xphb.md).\
      \ The dragon can't take this action again until the start of its next turn."
    "name": "Cloaked Flight"
  - "desc": "The dragon uses Spellcasting to cast [Shatter](/Rules/Source/spells/shatter-xphb.md).\
      \ The dragon can't take this action again until the start of its next turn."
    "name": "Sonic Boom"
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/adult-blue-dragon-xmm.webp"
```{ #statblock}
