---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/adult-red-dracolich-tce/","tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/tce","ttrpg-cli/monster/cr/17","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Adult Red Dracolich"]}}
---

# [Adult Red Dracolich](Rules\Source\bestiary\dragon/adult-red-dracolich-tce.md)
...
"actions":
  ...
  - "desc": "Each creature of the dracolich's choice that is within 120 feet of the\
      ...
      \ [frightened](/Rules/Source/conditions.md#Frightened) for 1 minute. A creature\
...
"legendary_actions":
  - "desc": "The dracolich makes a Wisdom ([Perception](/Rules/Source/skills.md#Perception))\
      \ check."
    "name": "Detect"
  ...
  - "desc": "The dracolich beats its wings. Each creature within 10 feet of the dracolich\
      ...
      \ damage and be knocked [prone](/Rules/Source/conditions.md#Prone). The dracolich\
      \ can then fly up to half its flying speed."
    "name": "Wing Attack (Costs 2 Actions)"
"source":
  - "TCE"
"image": "/Rules/Source/bestiary/dragon/token/adult-red-dracolich-tce.webp"
```
^statblock