---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/green-dragon-wyrmling-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon/chromatic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon/chromatic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Green Dragon Wyrmling"]}}
---

# [Green Dragon Wyrmling](Rules\Source\bestiary\dragon/green-dragon-wyrmling-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 7 (1d10 + 2) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 11, each creature in a 15-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 21 (6d6) Poison damage. *Success:* Half damage."
    "name": "Poison Breath (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/green-dragon-wyrmling-xmm.webp"
```{ #statblock}
