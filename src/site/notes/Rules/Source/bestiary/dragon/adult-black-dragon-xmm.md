---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/adult-black-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/14","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/chromatic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/14","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/dragon/chromatic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Adult Black Dragon"]}}
---

# [Adult Black Dragon](Rules\Source\bestiary\dragon/adult-black-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Melf's Acid Arrow](/Rules/Source/spells/melfs-acid-arrow-xphb.md)\
      \ (level 3 version)."
    "name": "Multiattack"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Fear](/Rules/Source/spells/fear-xphb.md), [Melf's Acid Arrow](/Rules/Source/spells/melfs-acid-arrow-xphb.md)\
      \ (level 3 version)\n\n**1/day each:** [Speak with Dead](/Rules/Source/spells/speak-with-dead-xphb.md),\
      \ [Vitriolic Sphere](/Rules/Source/spells/vitriolic-sphere-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient black dragon's lair is warped\
      ...
      \ area [Lightly Obscured](/Rules/Source/variant-rules/lightly-obscured-xphb.md).\
      ...
      \ succeed on a DC 15 Constitution saving throw or have the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
...
"legendary_actions":
  - "desc": "*Dexterity Saving Throw:* DC 17, one creature the dragon can see within\
      \ 120 feet. *Failure:* 22 (4d10) Poison damage, and the target has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
      \ on saving throws to maintain [Concentration](/Rules/Source/conditions.md#Concentration)\
  ...
  - "desc": "The dragon uses Spellcasting to cast [Fear](/Rules/Source/spells/fear-xphb.md).\
      \ The dragon can't take this action again until the start of its next turn."
    "name": "Frightful Presence"
  - "desc": "The dragon can move up to half its [Speed](/Rules/Source/variant-rules/speed-xphb.md),\
      \ and it makes one Rend attack."
    "name": "Pounce"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/adult-black-dragon-xmm.webp"
```{ #statblock}
