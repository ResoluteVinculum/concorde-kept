---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/young-gold-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon/metallic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon/metallic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Young Gold Dragon"]}}
---

# [Young Gold Dragon](Rules\Source\bestiary\dragon/young-gold-dragon-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 10 ft. *Hit:* 17 (2d10 + 6) Slashing\
      \ damage."
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 17, each creature in a 30-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "*Strength Saving Throw:* DC 17, each creature that isn't currently affected\
      \ by this breath in a 30-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/young-gold-dragon-xmm.webp"
```{ #statblock}
