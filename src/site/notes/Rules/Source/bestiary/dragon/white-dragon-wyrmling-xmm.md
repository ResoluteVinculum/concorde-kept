---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/white-dragon-wyrmling-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/arctic","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon/chromatic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/arctic","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/dragon/chromatic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["White Dragon Wyrmling"]}}
---

# [White Dragon Wyrmling](Rules\Source\bestiary\dragon/white-dragon-wyrmling-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 6 (1d8 + 2) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 15-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 22 (5d8) Cold damage. *Success:* Half damage."
    "name": "Cold Breath (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/white-dragon-wyrmling-xmm.webp"
```{ #statblock}
