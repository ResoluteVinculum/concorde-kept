---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/ancient-bronze-dragon-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/22","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/metallic"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/22","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/dragon/metallic"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Ancient Bronze Dragon"]}}
---

# [Ancient Bronze Dragon](Rules\Source\bestiary\dragon/ancient-bronze-dragon-xmm.md)
...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Repulsion Breath or (B) Spellcasting to cast [Guiding Bolt](/Rules/Source/spells/guiding-bolt-xphb.md)\
      \ (level 2 version)."
    "name": "Multiattack"
  ...
  - "desc": "*Strength Saving Throw:* DC 23, each creature in a 30-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target is pushed up to 60 feet straight away from the dragon\
      \ and has the [Prone](/Rules/Source/conditions.md#Prone) condition."
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Guiding Bolt](/Rules/Source/spells/guiding-bolt-xphb.md) (level 2 version),\
      ...
      \ [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md), [Control\
      \ Water](/Rules/Source/spells/control-water-xphb.md), [Scrying](/Rules/Source/spells/scrying-xphb.md),\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient bronze dragon's lair is changed\
      ...
      \ Creatures within 1 mile of the lair that lack a [Swim Speed](/Rules/Source/variant-rules/swim-speed-xphb.md)\
      \ ignore the extra cost of movement while swimming.  \n- **Sun and Storms.**\
      \ While in its lair, the dragon can cast [Control Weather](/Rules/Source/spells/control-weather-xphb.md),\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 22, each creature in a 20-foot-radius\
      ...
      \ damage, and the target has the [Deafened](/Rules/Source/conditions.md#Deafened)\
      \ condition until the end of its next turn."
    "name": "Thunderclap"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/ancient-bronze-dragon-xmm.webp"
```{ #statblock}
