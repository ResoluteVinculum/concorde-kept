...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 3 version)\n\n**1/day each:** [Scrying](/Rules/Source/spells/scrying-xphb.md),\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/ancient-blue-dragon-xmm.webp"
```{ #statblock}
