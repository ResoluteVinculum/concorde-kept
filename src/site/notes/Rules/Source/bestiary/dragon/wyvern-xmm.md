---
{"dg-publish":true,"permalink":"/rules/source/bestiary/dragon/wyvern-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/dragon"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Wyvern"]}}
---

# [Wyvern](Rules\Source\bestiary\dragon/wyvern-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 10 ft. *Hit:* 11 (2d6 + 4) Piercing damage\
      \ plus 24 (7d6) Poison damage, and the target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition until the start of the wyvern's next turn."
    "name": "Sting"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/dragon/token/wyvern-xmm.webp"
```{ #statblock}
