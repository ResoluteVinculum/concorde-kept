...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one creature. *Hit:* 19\
      ...
      \ throw or be [stunned](/Rules/Source/conditions.md#Stunned) for 1 minute. The\
      \ [stunned](/Rules/Source/conditions.md#Stunned) target can repeat the saving\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/giant/token/spirit-troll-mpmm.webp"
```{ #statblock}
