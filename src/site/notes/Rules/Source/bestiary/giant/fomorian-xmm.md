...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 16, one creature the fomorian can see within\
      \ 120 feet. *Failure:* 21 (6d6) Psychic damage, and the target gains 1 [Exhaustion](/Rules/Source/conditions.md#Exhaustion)\
      \ level. *Success:* Half damage only."
    "name": "Warping Hex (Recharge 4-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/giant/token/fomorian-xmm.webp"
```{ #statblock}
