...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +11, range 60/240 ft. *Hit:* 23 (3d10 + 7) Bludgeoning\
      ...
      \ away from the giant and has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
      \ on the next attack roll it makes before the end of its next turn."
    "name": "Hammer Throw"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/giant/token/fire-giant-xmm.webp"
```{ #statblock}
