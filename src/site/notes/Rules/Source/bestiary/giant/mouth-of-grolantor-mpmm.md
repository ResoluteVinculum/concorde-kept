---
{"dg-publish":true,"permalink":"/rules/source/bestiary/giant/mouth-of-grolantor-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/giant/hill-giant"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/giant/hill-giant"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Mouth of Grolantor"]}}
---

# [Mouth of Grolantor](Rules\Source\bestiary\giant/mouth-of-grolantor-mpmm.md)
...
"cr": "6"
"traits":
  - "desc": "The giant is immune to the [confusion](/Rules/Source/spells/confusion-xphb.md)\
      ...
      \ and it is [stunned](/Rules/Source/conditions.md#Stunned) until the start of\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/giant/token/mouth-of-grolantor-mpmm.webp"
```{ #statblock}
