---
{"dg-publish":true,"permalink":"/rules/source/bestiary/giant/storm-giant-quintessent-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/16","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/giant"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/16","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/underwater","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/giant"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Storm Giant Quintessent"]}}
---

# [Storm Giant Quintessent](Rules\Source\bestiary\giant/storm-giant-quintessent-mpmm.md)
...
"lair_actions":
  - "desc": "A storm giant quintessent can use lair actions in giant form and while\
      ...
      \ or be [deafened](/Rules/Source/conditions.md#Deafened) until the end of its\
      \ next turn.  \n- **Fog.** The giant creates a 20-foot-radius sphere of fog\
      \ (or murky water if within water) centered on a point anywhere in its lair.\
...
"legendary_actions":
  ...
  - "desc": "The giant vanishes, dispersing itself into the storm surrounding its\
      ...
      \ creature is using a [control weather](/Rules/Source/spells/control-weather-xphb.md)\
      \ spell or similar magic to quell the storm."
    "name": "One with the Storm (Costs 3 Actions)"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/giant/token/storm-giant-quintessent-mpmm.webp"
```{ #statblock}
