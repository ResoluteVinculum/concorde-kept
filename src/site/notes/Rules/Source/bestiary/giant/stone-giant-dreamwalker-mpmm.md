---
{"dg-publish":true,"permalink":"/rules/source/bestiary/giant/stone-giant-dreamwalker-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/giant"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/giant"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Stone Giant Dreamwalker"]}}
---

# [Stone Giant Dreamwalker](Rules\Source\bestiary\giant/stone-giant-dreamwalker-mpmm.md)
...
"traits":
  - "desc": "An enemy that starts its turn within 30 feet of the giant must make a\
      \ DC 13 Charisma saving throw, provided that the giant isn't [incapacitated](/Rules/Source/conditions.md#Incapacitated).\
      \ On a failed save, the creature is [charmed](/Rules/Source/conditions.md#Charmed)\
      \ by the giant. A creature [charmed](/Rules/Source/conditions.md#Charmed) in\
...
"actions":
  ...
  - "desc": "The giant touches one Medium or smaller creature within 10 feet of it\
      \ that is [charmed](/Rules/Source/conditions.md#Charmed) by it. The target must\
      \ make a DC 17 Constitution saving throw. On a failed save, the target becomes\
      \ [petrified](/Rules/Source/conditions.md#Petrified), and the giant can adhere\
      \ the target to its stony body. [greater restoration](/Rules/Source/spells/greater-restoration-xphb.md)\
      \ spells and other magic that can undo petrification have no effect on a [petrified](/Rules/Source/conditions.md#Petrified)\
      \ creature adhered to the giant unless the giant is dead, in which case the\
      \ magic works normally, freeing the [petrified](/Rules/Source/conditions.md#Petrified)\
      \ creature as well as ending the [petrified](/Rules/Source/conditions.md#Petrified)\
      \ condition on it."
    "name": "Petrifying Touch"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/giant/token/stone-giant-dreamwalker-mpmm.webp"
```{ #statblock}
