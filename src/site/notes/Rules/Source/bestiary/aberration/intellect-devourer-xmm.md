---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/intellect-devourer-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/tiny","ttrpg-cli/monster/type/aberration"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/tiny","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Intellect Devourer"]}}
---

# [Intellect Devourer](Rules\Source\bestiary\aberration/intellect-devourer-xmm.md)
...
"actions":
  ...
  - "desc": "*Intelligence Saving Throw:* DC 12, one Small or Medium creature within\
      \ 5 feet that has the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      \ condition, is a Humanoid or Beast, and has 10 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      ...
      \ brain by means of a [Wish](/Rules/Source/spells/wish-xphb.md) spell. By spending\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/intellect-devourer-xmm.webp"
```{ #statblock}
