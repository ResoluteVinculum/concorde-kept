...
"skillsaves":
  - "name": "[Perception](/Rules/Source/skills.md#Perception)"
    "desc": "+6"
"condition_immunities": "[blinded](/Rules/Source/conditions.md#Blinded)"
"senses": "[blindsight](/Rules/Source/senses.md#Blindsight) 500 ft. (blind beyond\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), a balhannoth can take\
      ...
      \ becomes [invisible](/Rules/Source/conditions.md#Invisible) to that creature\
...
"legendary_actions":
  - "desc": "The balhannoth makes one Bite attack against one creature it has [grappled](/Rules/Source/conditions.md#Grappled)."
    "name": "Bite"
  - "desc": "The balhannoth teleports, along with any equipment it is wearing or carrying\
      \ and any creatures it has [grappled](/Rules/Source/conditions.md#Grappled),\
      \ up to 60 feet to an unoccupied space it can see."
    "name": "Teleport"
  - "desc": "The balhannoth magically becomes [invisible](/Rules/Source/conditions.md#Invisible)\
      \ for up to 10 minutes or until immediately after it makes an attack roll."
    "name": "Vanish"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/balhannoth-mpmm.webp"
```{ #statblock}
