---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/githyanki-knight-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/environment/astral","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration/gith"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/environment/astral","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration/gith"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Githyanki Knight"]}}
---

# [Githyanki Knight](Rules\Source\bestiary\aberration/githyanki-knight-xmm.md)
*Source: Monster Manual (2024) p. 135*  

Githyanki knights wield silver blades to slay magic-users who use the [[Rules/Source/spells/astral-projection-xphb\|Astral Projection]] spell to intrude on githyanki territories on the Astral Plane. These silver blades are sacred to the githyanki. Non-githyanki who claim these weapons often find themselves hunted by wrathful githyanki knights.
...
"saves":
  ...
  - "wisdom": !!int "5"
"gear":
  - "[plate armor](/Rules/Source/items/plate-armor-xphb.md)"
"senses": "passive Perception 12"
"languages": "Common, Gith"
"cr": "8"
"actions":
  - "desc": "The githyanki makes three Silver Sword attacks. It can replace one attack\
      \ with a use of Spellcasting to cast [Telekinesis](/Rules/Source/spells/telekinesis-xphb.md)\
      \ if available."
    "name": "Multiattack"
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 10 (2d6 + 3) Slashing damage\
      ...
      \ body (as with the [Astral Projection](/Rules/Source/spells/astral-projection-xphb.md)\
  ...
  - "desc": "The githyanki casts one of the following spells, requiring no spell components\
      ...
      **At will:** [Mage Hand](/Rules/Source/spells/mage-hand-xphb.md) (the hand is\
      \ [Invisible](/Rules/Source/conditions.md#Invisible))\n\n**2/day each:** [Nondetection](/Rules/Source/spells/nondetection-xphb.md)\
      \ (self only), [Tongues](/Rules/Source/spells/tongues-xphb.md)\n\n**1/day each:**\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/githyanki-knight-xmm.webp"
```{ #statblock}
