...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 90-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The githyanki casts one of the following spells, requiring no spell components\
      ...
      \ each:** [Nondetection](/Rules/Source/spells/nondetection-xphb.md) (self only),\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/githyanki-dracomancer-xmm.webp"
```{ #statblock}
