---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/neothelid-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/aberration"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/13","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/gargantuan","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Neothelid"]}}
---

# [Neothelid](Rules\Source\bestiary\aberration/neothelid-mpmm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +13 to hit, reach 15 ft., one target. *Hit:* 21\
      ...
      \ throw or be swallowed by the neothelid. A swallowed creature is [blinded](/Rules/Source/conditions.md#Blinded)\
      \ and [restrained](/Rules/Source/conditions.md#Restrained), it has total cover\
      ...
      \ must succeed on a DC 18 Constitution saving throw at the end of that turn\
      \ or regurgitate all swallowed creatures, which fall [prone](/Rules/Source/conditions.md#Prone)\
      \ in a space within 10 feet of the neothelid. If the neothelid dies, a swallowed\
      \ creature is no longer [restrained](/Rules/Source/conditions.md#Restrained)\
  ...
  - "desc": "The neothelid casts one of the following spells, requiring no spell components\
      ...
      \ [feeblemind](/Rules/Source/spells/befuddlement-xphb.md), [telekinesis](/Rules/Source/spells/telekinesis-xphb.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/neothelid-mpmm.webp"
```{ #statblock}
