---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/gauth-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration/beholder"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration/beholder"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Gauth"]}}
---

# [Gauth](Rules\Source\bestiary\aberration/gauth-mpmm.md)
...
"traits":
  - "desc": "When a creature that can see the gauth's central eye starts its turn\
      ...
      \ saving throw if the gauth isn't [incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      \ and can see the creature. A creature that fails the save is [stunned](/Rules/Source/conditions.md#Stunned)\
      \ until the start of its next turn.\n\nUnless [surprised](/Rules/Source/conditions.md#Surprised),\
...
"actions":
  ...
  - "desc": "The gauth shoots three of the following magical eye rays at random (roll\
      ...
      \ asleep and remain [unconscious](/Rules/Source/conditions.md#Unconscious) for\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/gauth-mpmm.webp"
```{ #statblock}
