...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 10 ft., one target. *Hit:* 5\
      ...
      \ is [grappled](/Rules/Source/conditions.md#Grappled) (escape DC 15). Until\
      \ this grapple ends, the target is [restrained](/Rules/Source/conditions.md#Restrained),\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/choker-mpmm.webp"
```{ #statblock}
