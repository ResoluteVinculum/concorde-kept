---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/death-kiss-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/aberration/beholder"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/aberration/beholder"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Death Kiss"]}}
---

# [Death Kiss](Rules\Source\bestiary\aberration/death-kiss-mpmm.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 20 ft., one target. *Hit:* 11\
      \ (2d6 + 4) piercing damage, and the target is [grappled](/Rules/Source/conditions.md#Grappled)\
      \ (escape DC 14) if it is a Huge or smaller creature. Until this grapple ends,\
      \ the target is [restrained](/Rules/Source/conditions.md#Restrained), and the\
      \ death kiss can't use the same tentacle on another target. The death kiss has\
      \ ten tentacles."
    "name": "Tentacle"
  - "desc": "One creature [grappled](/Rules/Source/conditions.md#Grappled) by a tentacle\
      \ of the death kiss must make a DC 16 Constitution saving throw. On a failed\
      \ save, the target takes 22 (4d10) lightning damage, and the death kiss regains\
      \ half as many hit points."
    "name": "Blood Drain"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/death-kiss-mpmm.webp"
```{ #statblock}
