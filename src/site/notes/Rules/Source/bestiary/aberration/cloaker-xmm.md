...
"cr": "8"
"traits":
  - "desc": "While in [Bright Light](/Rules/Source/variant-rules/bright-light-xphb.md),\
      \ the cloaker has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
      \ on attack rolls."
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 13 (3d6 + 3) Piercing damage.\
      ...
      \ While the cloaker is attached, the target has the [Blinded](/Rules/Source/conditions.md#Blinded)\
      ...
      \ a DC 14 Strength ([Athletics](/Rules/Source/skills.md#Athletics)) check."
    "name": "Attach"
  - "desc": "*Melee Attack Roll:* +6, reach 10 ft. *Hit:* 8 (1d10 + 3) Slashing damage."
    "name": "Tail"
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 13, each creature in a 60-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the cloaker. *Failure:* The target has the [Frightened](/Rules/Source/conditions.md#Frightened)\
    ...
    "name": "Moan"
  - "desc": "The cloaker casts the [Mirror Image](/Rules/Source/spells/mirror-image-xphb.md)\
      ...
      \ Light](/Rules/Source/variant-rules/bright-light-xphb.md).\n"
    "name": "Phantasms (Recharge after a Short or Long Rest)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/cloaker-xmm.webp"
```{ #statblock}
