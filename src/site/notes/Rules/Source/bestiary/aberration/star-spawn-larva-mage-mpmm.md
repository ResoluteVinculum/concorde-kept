...
"traits":
  - "desc": "When the mage is reduced to 0 hit points, it breaks apart into a [swarm\
      \ of insects](/Rules/Source/bestiary/beast/swarm-of-insects-xmm.md) in the same\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. *Hit:* 7\
      ...
      \ saving throw or be [poisoned](/Rules/Source/conditions.md#Poisoned) until\
  ...
  - "desc": "Each creature other than a star spawn within 10 feet of the mage must\
      ...
      \ and be [blinded](/Rules/Source/conditions.md#Blinded) and [restrained](/Rules/Source/conditions.md#Restrained)\
  ...
  - "desc": "The mage casts one of the following spells, requiring no material components\
      ...
      \ will:** [mage hand](/Rules/Source/spells/mage-hand-xphb.md), [message](/Rules/Source/spells/message-xphb.md),\
      \ [minor illusion](/Rules/Source/spells/minor-illusion-xphb.md)\n\n**1/day:**\
      \ [dominate monster](/Rules/Source/spells/dominate-monster-xphb.md)"
    "name": "Spellcasting"
"reactions":
...
"legendary_actions":
  ...
  - "desc": "Each creature [restrained](/Rules/Source/conditions.md#Restrained) by\
      \ the mage's Plague of Worms takes 13 (3d8) necrotic damage, and the mage gains\
      \ 6 temporary hit points."
    "name": "Feed (Costs 3 Actions)"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/star-spawn-larva-mage-mpmm.webp"
```{ #statblock}
