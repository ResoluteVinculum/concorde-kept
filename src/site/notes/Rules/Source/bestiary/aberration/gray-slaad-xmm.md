...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 9 (1d10 + 4) Slashing damage\
      ...
      \ the target has a condition determined by rolling 1d4: on a 1, [Charmed](/Rules/Source/conditions.md#Charmed);\
  ...
  - "desc": "The slaad casts one of the following spells, requiring no Material components\
      ...
      \n**1/day each:** [Cloudkill](/Rules/Source/spells/cloudkill-xphb.md), [Fly](/Rules/Source/spells/fly-xphb.md),\
      \ [Plane Shift](/Rules/Source/spells/plane-shift-xphb.md) (self only), [Tongues](/Rules/Source/spells/tongues-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/gray-slaad-xmm.webp"
```{ #statblock}
