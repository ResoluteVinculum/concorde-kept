...
"actions":
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 22 (4d8 + 4) Psychic damage.\
      ...
      \ has the [Stunned](/Rules/Source/conditions.md#Stunned) condition until the\
      \ grapple ends."
    "name": "Tentacles"
  - "desc": "*Constitution Saving Throw:* DC 15, one creature that is [Grappled](/Rules/Source/conditions.md#Grappled)\
      ...
      \ [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md), the mind flayer\
      \ kills it and devours its brain."
    "name": "Extract Brain"
  - "desc": "*Intelligence Saving Throw:* DC 15, each creature in a 60-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 31 (6d8 + 4) Psychic damage, and the target has the [Stunned](/Rules/Source/conditions.md#Stunned)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/mind-flayer-xmm.webp"
```{ #statblock}
