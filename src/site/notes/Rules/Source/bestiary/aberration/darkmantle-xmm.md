---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/darkmantle-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/aberration"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1-2","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Darkmantle"]}}
---

# [Darkmantle](Rules\Source\bestiary\aberration/darkmantle-xmm.md)
...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 6 (1d6 + 3) Bludgeoning damage,\
      ...
      \ creature and the darkmantle had [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      \ on the attack roll, it covers the target, which has the [Blinded](/Rules/Source/conditions.md#Blinded)\
      ...
      \ has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md) on its attack\
      \ rolls. Its [Speed](/Rules/Source/variant-rules/speed-xphb.md) becomes 0, it\
      \ can't benefit from any bonus to its [Speed](/Rules/Source/variant-rules/speed-xphb.md),\
      \ and it moves with the target.\n\nA creature can take an action to try to detach\
      \ the darkmantle from itself, doing so with a successful DC 13 Strength ([Athletics](/Rules/Source/skills.md#Athletics))\
      \ check. On its turn, the darkmantle can detach itself by using 5 feet of movement."
    "name": "Crush"
  - "desc": "Magical [Darkness](/Rules/Source/variant-rules/darkness-xphb.md) fills\
      \ a 15-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the darkmantle. This effect lasts while the darkmantle maintains\
      \ [Concentration](/Rules/Source/conditions.md#Concentration) on it, up to 10\
      \ minutes. Darkvision can't penetrate this area, and no light can illuminate\
      \ it."
    "name": "Darkness Aura (1/Day)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/darkmantle-xmm.webp"
```{ #statblock}
