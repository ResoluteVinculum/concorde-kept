---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/blue-slaad-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/limbo","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/aberration"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/limbo","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Blue Slaad"]}}
---

# [Blue Slaad](Rules\Source\bestiary\aberration/blue-slaad-xmm.md)
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
      ...
      \ *Failure:* The target is cursed. The cursed target can't regain [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md),\
      \ and its [Hit Point](/Rules/Source/variant-rules/hit-points-xphb.md) maximum\
      \ decreases by 10 (3d6) after every 24 hours and doesn't return to normal after\
      \ finishing a [Long Rest](/Rules/Source/variant-rules/long-rest-xphb.md). If\
      \ the curse reduces the target's [Hit Point](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ maximum to 0, the curse ends, and instead of dying, the target instantly transforms\
      \ into a [Red Slaad](/Rules/Source/bestiary/aberration/red-slaad-xmm.md) or,\
      \ if it can cast spells of level 3 or higher, a [Green Slaad](/Rules/Source/bestiary/aberration/green-slaad-xmm.md).\
      \ Only a [Wish](/Rules/Source/spells/wish-xphb.md) spell can reverse this transformation."
    "name": "Mutating Claw"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/blue-slaad-xmm.webp"
```{ #statblock}
