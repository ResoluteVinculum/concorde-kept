...
"actions":
  ...
  - "desc": "The beholder randomly shoots one of the following magical rays at a target\
      ...
      \ [Charmed](/Rules/Source/conditions.md#Charmed) condition for 1 hour or until\
      \ it takes damage. *Success:* Half damage only.  \n- **2 Paralyzing Ray.** *Constitution\
      \ Saving Throw:* DC 16. *Failure:* The target has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed)\
      ...
      \ Necrotic damage. Until the end of the target's next turn, the target's [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ is halved; the target can't take Reactions; and it can take either an action\
      \ or a [Bonus Action](/Rules/Source/variant-rules/bonus-action-xphb.md) on its\
      \ turn, not both. *Success:* Half damage only.  \n- **5 Enervation Ray.** *Constitution\
      \ Saving Throw:* DC 16. *Failure:* 13 (3d8) Poison damage, and the target has\
      \ the [Poisoned](/Rules/Source/conditions.md#Poisoned) condition until the end\
      \ of its next turn. While [Poisoned](/Rules/Source/conditions.md#Poisoned),\
      ...
      \ the [Restrained](/Rules/Source/conditions.md#Restrained) condition until the\
      \ start of the beholder's next turn or until the beholder has the [Incapacitated](/Rules/Source/conditions.md#Incapacitated)\
      ...
      \ it is a Construct or an Undead). *Failure:* The target has the [Unconscious](/Rules/Source/conditions.md#Unconscious)\
      ...
      \ Ray.** *Dexterity Saving Throw:* DC 16. *Failure:* 36 (8d8) Force damage.\
    ...
    "name": "Eye Rays"
"bonus_actions":
  - "desc": "The beholder's central eye emits an antimagic wave in a 150-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
      \ Until the start of the beholder's next turn, that area acts as an [Antimagic\
      \ Field](/Rules/Source/spells/antimagic-field-xphb.md) spell, and that area\
...
"regional_effects":
  - "desc": "The region containing a beholder's lair is twisted by its presence, creating\
      ...
      \ 1 mile of the lair that makes a [D20 Test](/Rules/Source/variant-rules/d20-test-xphb.md)\
      \ and rolls a 1 has the [Prone](/Rules/Source/conditions.md#Prone) condition.\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/beholder-xmm.webp"
```{ #statblock}
