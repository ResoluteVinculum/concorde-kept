...
"actions":
  ...
  - "desc": "The githzerai casts one of the following spells, requiring no spell components\
      ...
      \ [Mage Hand](/Rules/Source/spells/mage-hand-xphb.md) (the hand is [Invisible](/Rules/Source/conditions.md#Invisible))\n\
      \n**1/day each:** [Phantasmal Killer](/Rules/Source/spells/phantasmal-killer-xphb.md)\
      \ (level 6 version), [Plane Shift](/Rules/Source/spells/plane-shift-xphb.md),\
      \ [See Invisibility](/Rules/Source/spells/see-invisibility-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The githzerai casts [Jump](/Rules/Source/spells/jump-xphb.md), requiring\
      \ no spell components and using the same spellcasting ability as Spellcasting.\n"
    "name": "Psi-Powered Leap (2/Day)"
"reactions":
  - "desc": "The githzerai casts [Feather Fall](/Rules/Source/spells/feather-fall-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/aberration/token/githzerai-zerth-xmm.webp"
```{ #statblock}
