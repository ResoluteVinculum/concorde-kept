...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 10 ft., one creature. *Hit:*\
      \ 20 (4d8 + 2) psychic damage. If the target is Large or smaller, it is [grappled](/Rules/Source/conditions.md#Grappled)\
      \ (escape DC 13), and it must succeed on a DC 13 Intelligence saving throw or\
      \ be [restrained](/Rules/Source/conditions.md#Restrained) until this grapple\
      \ ends."
    "name": "Tentacles"
  - "desc": "The mindwitness shoots one magical eye ray at random (roll a d6, and\
      ...
      \ saving throw or be [frightened](/Rules/Source/conditions.md#Frightened) for\
      ...
      \ succeed on a DC 13 Constitution saving throw or be [stunned](/Rules/Source/conditions.md#Stunned)\
      ...
      \ and it is [restrained](/Rules/Source/conditions.md#Restrained) by the ray's\
      \ telekinetic grip until the start of the mindwitness's next turn or until the\
      \ mindwitness is [incapacitated](/Rules/Source/conditions.md#Incapacitated).\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/mindwitness-mpmm.webp"
```{ #statblock}
