---
{"dg-publish":true,"permalink":"/rules/source/bestiary/aberration/swarm-of-cranium-rats-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/5","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/aberration"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Swarm of Cranium Rats"]}}
---

# [Swarm of Cranium Rats](Rules\Source\bestiary\aberration/swarm-of-cranium-rats-mpmm.md)
...
"actions":
  ...
  - "desc": "As long as it has more than half of its hit points remaining, the swarm\
      ...
      \ [command](/Rules/Source/spells/command-xphb.md), [comprehend languages](/Rules/Source/spells/comprehend-languages-xphb.md),\
      \ [detect thoughts](/Rules/Source/spells/detect-thoughts-xphb.md)\n\n**1/day\
      \ each:** [confusion](/Rules/Source/spells/confusion-xphb.md), [dominate monster](/Rules/Source/spells/dominate-monster-xphb.md)"
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/aberration/token/swarm-of-cranium-rats-mpmm.webp"
```{ #statblock}
