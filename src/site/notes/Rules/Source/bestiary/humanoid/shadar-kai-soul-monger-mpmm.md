---
{"dg-publish":true,"permalink":"/rules/source/bestiary/humanoid/shadar-kai-soul-monger-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid/elf"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/11","ttrpg-cli/monster/environment/underdark","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid/elf"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Shadar-kai Soul Monger"]}}
---

# [Shadar-kai Soul Monger](Rules\Source\bestiary\humanoid/shadar-kai-soul-monger-mpmm.md)
...
"ac": !!int "15"
"ac_class": "[studded leather](/Rules/Source/items/studded-leather-armor-xphb.md)"
"hp": !!int "136"
"hit_dice": "21d8 + 42"
"modifier": !!int "3"
"stats":
...
"cr": "11"
"traits":
  - "desc": "The shadar-kai has advantage on saving throws against being [charmed](/Rules/Source/conditions.md#Charmed),\
...
"actions":
  ...
  - "desc": "The shadar-kai emits weariness in a 60-foot cube. Each creature in that\
      ...
      \ takes 45 (10d8) psychic damage and suffers 1 level of [exhaustion](/Rules/Source/conditions.md#Exhaustion).\
      \ On a successful save, it takes half as much damage and doesn't gain a level\
      \ of [exhaustion](/Rules/Source/conditions.md#Exhaustion)."
  ...
  - "desc": "The shadar-kai casts one of the following spells, requiring no material\
      ...
      \ DC 16):\n\n**1/day each:** [bestow curse](/Rules/Source/spells/bestow-curse-xphb.md),\
      \ [finger of death](/Rules/Source/spells/finger-of-death-xphb.md), [gaseous\
      \ form](/Rules/Source/spells/gaseous-form-xphb.md), [seeming](/Rules/Source/spells/seeming-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/shadar-kai-soul-monger-mpmm.webp"
```{ #statblock}
