...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Piercing damage,\
      \ and the pirate has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/pirate-captain-xmm.webp"
```{ #statblock}
