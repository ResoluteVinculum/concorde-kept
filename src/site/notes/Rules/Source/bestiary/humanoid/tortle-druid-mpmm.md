---
{"dg-publish":true,"permalink":"/rules/source/bestiary/humanoid/tortle-druid-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/2","ttrpg-cli/monster/environment/coastal","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Tortle Druid"]}}
---

# [Tortle Druid](Rules\Source\bestiary\humanoid/tortle-druid-mpmm.md)
...
"speed": "30 ft."
"skillsaves":
  - "name": "[Animal Handling](/Rules/Source/skills.md#Animal%20Handling)"
    "desc": "+4"
...
"traits":
  - "desc": "The tortle can hold its breath for 1 hour."
    "name": "Hold Breath"
"actions":
  - "desc": "The tortle makes four Claw attacks or two [Nature](/Rules/Source/skills.md#Nature)'s\
      \ Wrath attacks."
    "name": "Multiattack"
  ...
  - "desc": "The tortle withdraws into its shell. Until it emerges, it gains a +4\
      ...
      \ While in its shell, the tortle is [prone](/Rules/Source/conditions.md#Prone),\
  ...
  - "desc": "The tortle casts one of the following spells, using Wisdom as the spellcasting\
      \ ability (spell save DC 12):\n\n**At will:** [druidcraft](/Rules/Source/spells/druidcraft-xphb.md),\
      \ [guidance](/Rules/Source/spells/guidance-xphb.md)\n\n**2/day each:** [cure\
      \ wounds](/Rules/Source/spells/cure-wounds-xphb.md), [hold person](/Rules/Source/spells/hold-person-xphb.md),\
      \ [speak with animals](/Rules/Source/spells/speak-with-animals-xphb.md), [thunderwave](/Rules/Source/spells/thunderwave-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/tortle-druid-mpmm.webp"
```{ #statblock}
