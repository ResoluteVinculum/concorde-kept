...
"traits":
  ...
  - "desc": "Any creature that grapples the grung or otherwise comes into direct contact\
      ...
      \ become [poisoned](/Rules/Source/conditions.md#Poisoned) for 1 minute. A [poisoned](/Rules/Source/conditions.md#Poisoned)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/grung-elite-warrior-mpmm.webp"
```{ #statblock}
