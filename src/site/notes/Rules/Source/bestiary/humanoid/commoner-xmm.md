...
"traits":
  - "desc": "The commoner has proficiency in one skill of the DM's choice and has\
      \ [Advantage](/Rules/Source/variant-rules/advantage-xphb.md) whenever it makes\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/commoner-xmm.webp"
```{ #statblock}
