...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 8 (1d8 + 4) Piercing damage\
    ...
    "name": "Rapier"
  - "desc": "*Wisdom Saving Throw:* DC 15, each creature in a 20-foot-radius [Sphere](/Rules/Source/variant-rules/sphere-area-of-effect-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/performer-maestro-xmm.webp"
```{ #statblock}
