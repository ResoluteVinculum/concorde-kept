---
{"dg-publish":true,"permalink":"/rules/source/bestiary/humanoid/githyanki-supreme-commander-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/14","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid/gith"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/14","ttrpg-cli/monster/environment/desert","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/environment/urban","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/humanoid/gith"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Githyanki Supreme Commander"]}}
---

# [Githyanki Supreme Commander](Rules\Source\bestiary\humanoid/githyanki-supreme-commander-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 141*  

Supreme commanders lead armies, each one commanding ten kith'raks, who in turn lead the rest of their forces. Most supreme commanders ride [[Rules/Source/bestiary/dragon/adult-red-dragon-xmm\|red dragons]] into battle.
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 5 ft., one target. *Hit:* 14\
      ...
      \ against a target in an astral body (as with the [astral projection](/Rules/Source/spells/astral-projection-xphb.md)\
  ...
  - "desc": "The githyanki casts one of the following spells, requiring no spell components\
      ...
      **At will:** [mage hand](/Rules/Source/spells/mage-hand-xphb.md) (the hand is\
      \ invisible)\n\n**3/day each:** [levitate](/Rules/Source/spells/levitate-xphb.md)\
      \ (self only), [nondetection](/Rules/Source/spells/nondetection-xphb.md) (self\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/githyanki-supreme-commander-mpmm.webp"
```{ #statblock}
