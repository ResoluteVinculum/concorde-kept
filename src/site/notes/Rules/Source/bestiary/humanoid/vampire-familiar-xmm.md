...
"condition_immunities": "[charmed](/Rules/Source/conditions.md#Charmed) (except from\
  \ its vampire master)"
"gear":
  - "ten [daggers](/Rules/Source/items/dagger-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +5, reach 5 ft. or range 20/60 ft. *Hit:*\
      ...
      \ reduced to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md)\
      \ by this attack, the target becomes [Stable](/Rules/Source/variant-rules/stable-xphb.md)\
      \ but has the [Poisoned](/Rules/Source/conditions.md#Poisoned) condition for\
      \ 1 hour. While it has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition, the target has the [Paralyzed](/Rules/Source/conditions.md#Paralyzed)\
      \ condition."
    "name": "Umbral Dagger"
"bonus_actions":
  - "desc": "The familiar takes the [Dash](/Rules/Source/actions.md#Dash) or [Disengage](/Rules/Source/actions.md#Disengage)\
      \ action."
    "name": "Deathless Agility"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/vampire-familiar-xmm.webp"
```{ #statblock}
