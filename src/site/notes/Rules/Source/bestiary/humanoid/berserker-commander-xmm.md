---
{"dg-publish":true,"permalink":"/rules/source/bestiary/humanoid/berserker-commander-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/humanoid"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/8","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/small-or-medium","ttrpg-cli/monster/type/humanoid"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Berserker Commander"]}}
---

# [Berserker Commander](Rules\Source\bestiary\humanoid/berserker-commander-xmm.md)
...
"cr": "8"
"traits":
  - "desc": "While [Bloodied](/Rules/Source/conditions.md#Bloodied), the berserker\
      \ has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md) on attack rolls\
      \ and saving throws."
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +7, reach 5 ft. or range 30/120 ft. *Hit:*\
      \ 18 (4d6 + 4) Piercing damage, and the target's [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ decreases by 5 feet until the start of the berserker's next turn."
    "name": "Javelin"
"bonus_actions":
  - "desc": "Each ally within 30 feet of the berserker can take a [Reaction](/Rules/Source/variant-rules/reaction-xphb.md)\
      \ to move up to half the ally's [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ without provoking [Opportunity Attacks](/Rules/Source/actions.md#Opportunity%20Attack).\
      \ The berserker can also move up to half its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      \ without provoking [Opportunity Attacks](/Rules/Source/actions.md#Opportunity%20Attack)."
    "name": "Frenzied Rush"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/berserker-commander-xmm.webp"
```{ #statblock}
