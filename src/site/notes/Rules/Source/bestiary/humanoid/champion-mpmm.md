...
| 12 | Black anvil cracked down the middle on an orange field |{ #champions-coat-of-arms}
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/champion-mpmm.webp"
```{ #statblock}
