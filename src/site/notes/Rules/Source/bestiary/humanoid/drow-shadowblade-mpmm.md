...
"cr": "11"
"traits":
  - "desc": "Magical darkness doesn't impede the drow's [darkvision](/Rules/Source/senses.md#Darkvision)."
    "name": "Devil's Sight"
...
"actions":
  ...
  - "desc": "The drow casts one of the following spells, requiring no material components\
      ...
      \ will:** [dancing lights](/Rules/Source/spells/dancing-lights-xphb.md), [darkness](/Rules/Source/spells/darkness-xphb.md)\n\
      \n**1/day each:** [faerie fire](/Rules/Source/spells/faerie-fire-xphb.md), [levitate](/Rules/Source/spells/levitate-xphb.md)\
      \ (self only)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/humanoid/token/drow-shadowblade-mpmm.webp"
```{ #statblock}
