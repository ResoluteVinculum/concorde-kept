...
"skillsaves":
  ...
  - "name": "[Stealth](/Rules/Source/skills.md#Stealth)"
    "desc": "+9"
"gear":
  - "six [daggers](/Rules/Source/items/dagger-xphb.md)"
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 14, each creature in a 10-foot-radius\
      ...
      \ damage, and the target has the [Blinded](/Rules/Source/conditions.md#Blinded)\
  ...
  - "desc": "The bandit casts one of the following spells, using Intelligence as the\
      ...
      \n**1/day each:** [Hold Person](/Rules/Source/spells/hold-person-xphb.md) (level\
      \ 4 version), [Mage Armor](/Rules/Source/spells/mage-armor-xphb.md) (included\
      \ in AC), [Major Image](/Rules/Source/spells/major-image-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/humanoid/token/bandit-deceiver-xmm.webp"
```{ #statblock}
