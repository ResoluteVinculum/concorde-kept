---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/bullywug-bog-sage-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/4","ttrpg-cli/monster/environment/swamp","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Bullywug Bog Sage"]}}
---

# [Bullywug Bog Sage](Rules\Source\bestiary\fey/bullywug-bog-sage-xmm.md)
...
"skillsaves":
  ...
  - "name": "[Stealth](/Rules/Source/skills.md#Stealth)"
    "desc": "+5"
"gear":
  - "[component pouch](/Rules/Source/items/component-pouch-xphb.md)"
...
"actions":
  ...
  - "desc": "The bullywug casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ [Dancing Lights](/Rules/Source/spells/dancing-lights-xphb.md), [Druidcraft](/Rules/Source/spells/druidcraft-xphb.md),\
      \ [Ray of Sickness](/Rules/Source/spells/ray-of-sickness-xphb.md)\n\n**1/day\
      \ each:** [Speak with Plants](/Rules/Source/spells/speak-with-plants-xphb.md),\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fey/token/bullywug-bog-sage-xmm.webp"
```{ #statblock}
