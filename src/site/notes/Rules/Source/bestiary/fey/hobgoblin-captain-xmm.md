...
"cr": "3"
"traits":
  - "desc": "While in a 10-foot [Emanation](/Rules/Source/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the hobgoblin, the hobgoblin and its allies have [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fey/token/hobgoblin-captain-xmm.webp"
```{ #statblock}
