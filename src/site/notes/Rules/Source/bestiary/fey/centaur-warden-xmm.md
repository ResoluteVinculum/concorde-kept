---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/centaur-warden-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/feywild","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fey"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/7","ttrpg-cli/monster/environment/feywild","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Centaur Warden"]}}
---

# [Centaur Warden](Rules\Source\bestiary\fey/centaur-warden-xmm.md)
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +7, range 90 ft. *Hit:* 14 (3d6 + 4) Radiant damage,\
      \ and the target has the [Blinded](/Rules/Source/conditions.md#Blinded) condition\
  ...
  - "desc": "The centaur casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ [Speak with Animals](/Rules/Source/spells/speak-with-animals-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The centaur moves up to its [Speed](/Rules/Source/variant-rules/speed-xphb.md)\
      ...
      \ 4) Bludgeoning damage, and the target has the [Restrained](/Rules/Source/conditions.md#Restrained)\
      \ condition until the end of its next turn."
    "name": "Entangling Trail (Recharge 5-6)"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fey/token/centaur-warden-xmm.webp"
```{ #statblock}
