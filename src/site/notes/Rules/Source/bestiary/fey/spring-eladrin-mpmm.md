---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/spring-eladrin-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey/elf"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey/elf"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Spring Eladrin"]}}
---

# [Spring Eladrin](Rules\Source\bestiary\fey/spring-eladrin-mpmm.md)
...
"actions":
  ...
  - "desc": "The eladrin casts one of the following spells, requiring no material\
      ...
      \n**At will:** [Tasha's hideous laughter](/Rules/Source/spells/tashas-hideous-laughter-xphb.md)\n\
      \n**1/day each:** [major image](/Rules/Source/spells/major-image-xphb.md), [suggestion](/Rules/Source/spells/suggestion-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fey/token/spring-eladrin-mpmm.webp"
```{ #statblock}
