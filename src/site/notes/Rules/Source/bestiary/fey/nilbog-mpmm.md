...
"traits":
  - "desc": "Any creature that attempts to damage the nilbog must first succeed on\
      \ a DC 12 Charisma saving throw or be [charmed](/Rules/Source/conditions.md#Charmed)\
      \ until the end of the creature's next turn. A creature [charmed](/Rules/Source/conditions.md#Charmed)\
...
"actions":
  ...
  - "desc": "The nilbog casts one of the following spells, using Charisma as the spellcasting\
      ...
      \ [Tasha's hideous laughter](/Rules/Source/spells/tashas-hideous-laughter-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The nilbog takes the [Disengage](/Rules/Source/actions.md#Disengage)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fey/token/nilbog-mpmm.webp"
```{ #statblock}
