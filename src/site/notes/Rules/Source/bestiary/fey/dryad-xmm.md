---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/dryad-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/1","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Dryad"]}}
---

# [Dryad](Rules\Source\bestiary\fey/dryad-xmm.md)
...
"cr": "1"
"traits":
  - "desc": "The dryad has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "The dryad makes one Vine Lash or Thorn Burst attack, and it can use Spellcasting\
      \ to cast [Charm Monster](/Rules/Source/spells/charm-monster-xphb.md)."
    "name": "Multiattack"
  ...
  - "desc": "The dryad casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Animal Friendship](/Rules/Source/spells/animal-friendship-xphb.md),\
      \ [Charm Monster](/Rules/Source/spells/charm-monster-xphb.md) (lasts 24 hours;\
      \ ends early if the dryad casts the spell again), [Druidcraft](/Rules/Source/spells/druidcraft-xphb.md)\n\
      \n**1/day each:** [Entangle](/Rules/Source/spells/entangle-xphb.md), [Pass without\
      \ Trace](/Rules/Source/spells/pass-without-trace-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fey/token/dryad-xmm.webp"
```{ #statblock}
