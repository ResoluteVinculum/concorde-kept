---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/autumn-eladrin-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey/elf"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/size/medium","ttrpg-cli/monster/type/fey/elf"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Autumn Eladrin"]}}
---

# [Autumn Eladrin](Rules\Source\bestiary\fey/autumn-eladrin-mpmm.md)
...
Whenever one of the eladrin presented here finishes a long rest, they can associate themself with a different season, provided they aren't [[Rules/Source/conditions#Incapacitated\|incapacitated]]. When the eladrin makes this change, they use the stat block of the new season rather than their old stat block. Any damage the eladrin sustained in their previous form applies to the new form, as do any conditions or other ongoing effects affecting them.
...
"traits":
  - "desc": "Any non-eladrin creature that starts its turn within 60 feet of the eladrin\
      ...
      \ [charmed](/Rules/Source/conditions.md#Charmed) by the eladrin for 1 minute.\
      \ On a successful save, the creature becomes immune to any eladrin's Enchanting\
      \ Presence for 24 hours.\n\nWhenever the eladrin deals damage to the [charmed](/Rules/Source/conditions.md#Charmed)\
      \ creature, the [charmed](/Rules/Source/conditions.md#Charmed) creature can\
...
"actions":
  ...
  - "desc": "The eladrin casts one of the following spells, requiring no material\
      ...
      \ each:** [cure wounds](/Rules/Source/spells/cure-wounds-xphb.md) (as a 5th-level\
      \ spell), [lesser restoration](/Rules/Source/spells/lesser-restoration-xphb.md)\n\
...
"reactions":
  - "desc": "If a creature [charmed](/Rules/Source/conditions.md#Charmed) by the eladrin\
      \ hits with an attack roll while within 60 feet of the eladrin, the eladrin\
      \ magically causes the attack to miss, provided the eladrin can see the attacker."
    "name": "Foster Peace"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fey/token/autumn-eladrin-mpmm.webp"
```{ #statblock}
