---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/arch-hag-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/21","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fey"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/21","ttrpg-cli/monster/environment/any","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Arch-hag"]}}
---

# [Arch-hag](Rules\Source\bestiary\fey/arch-hag-xmm.md)
...
"traits":
  - "desc": "While within 30 feet of at least two hag allies, the hag can cast one\
      ...
      \ save DC 19): [Augury](/Rules/Source/spells/augury-xphb.md), [Find Familiar](/Rules/Source/spells/find-familiar-xphb.md),\
  ...
  - "desc": "When the hag drops to 0 [Hit Points](/Rules/Source/variant-rules/hit-points-xphb.md),\
      \ it dies only if it is within 30 feet of its anathema (a thing the DM chooses\
      \ as the hag's most hated thing). Otherwise, the hag drops to 1 [Hit Point](/Rules/Source/variant-rules/hit-points-xphb.md)\
      ...
      \ of the space it left is cursed. Until the curse ends, a creature has [Disadvantage](/Rules/Source/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +14, reach 10 ft. or range 60 ft. *Hit:*\
    ...
    "name": "Spectral Claw"
  - "desc": "*Dexterity Saving Throw:* DC 22, each creature in a 60-foot [Cone](/Rules/Source/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The hag casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Thoughts](/Rules/Source/spells/detect-thoughts-xphb.md), [Dimension\
      \ Door](/Rules/Source/spells/dimension-door-xphb.md), [Dispel Magic](/Rules/Source/spells/dispel-magic-xphb.md),\
      \ [Hypnotic Pattern](/Rules/Source/spells/hypnotic-pattern-xphb.md)\n\n**2/day\
      \ each:** [Mass Suggestion](/Rules/Source/spells/mass-suggestion-xphb.md), [Modify\
      \ Memory](/Rules/Source/spells/modify-memory-xphb.md), [Plane Shift](/Rules/Source/spells/plane-shift-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "Each creature cursed by the hag and within 60 feet of it takes 14 (4d6)\
    ...
    "name": "Witch Strike"
"reactions":
  - "desc": "The hag casts [Counterspell](/Rules/Source/spells/counterspell-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing an arch-hag's lair is altered by its presence,\
      ...
      \ check they make when they take the [Influence](/Rules/Source/actions.md#Influence)\
      \ action.  \n- **Meddlesome Magic.** Whenever a creature other than the hag\
      \ or its allies finishes a [Long Rest](/Rules/Source/variant-rules/long-rest-xphb.md)\
      \ while within 1 mile of the lair, the next time that creature casts a spell\
      \ using a spell slot, it also casts [Confusion](/Rules/Source/spells/confusion-xphb.md)\
      \ centered on itself. The spell uses the creature's spellcasting ability and\
      \ doesn't require [Concentration](/Rules/Source/conditions.md#Concentration).\
...
"legendary_actions":
  - "desc": "The hag makes one Spectral Claw attack."
    "name": "Hag's Swipe"
  - "desc": "The hag uses Spellcasting to cast [Dimension Door](/Rules/Source/spells/dimension-door-xphb.md)\
      \ or [Hypnotic Pattern](/Rules/Source/spells/hypnotic-pattern-xphb.md). The\
      \ hag can't take this action again until the start of its next turn."
    "name": "Malicious Magic"
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fey/token/arch-hag-xmm.webp"
```{ #statblock}
