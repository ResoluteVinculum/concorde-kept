---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/dire-worg-xmm/","tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/feywild","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fey"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xmm","ttrpg-cli/monster/cr/10","ttrpg-cli/monster/environment/feywild","ttrpg-cli/monster/environment/forest","ttrpg-cli/monster/environment/grassland","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/planar","ttrpg-cli/monster/size/huge","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Dire Worg"]}}
---

# [Dire Worg](Rules\Source\bestiary\fey/dire-worg-xmm.md)
...
"cr": "10"
"traits":
  - "desc": "The worg has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 15 (2d8 + 6) Piercing damage\
      \ plus 7 (2d6) Poison damage, and the target has the [Poisoned](/Rules/Source/conditions.md#Poisoned)\
      \ condition until the start of the worg's next turn. While [Poisoned](/Rules/Source/conditions.md#Poisoned),\
  ...
  - "desc": "*Wisdom Saving Throw:* DC 16, each creature within 30 feet that isn't\
      \ a worg. *Failure:* 36 (8d8) Psychic damage, and the target has the [Frightened](/Rules/Source/conditions.md#Frightened)\
...
"source":
  - "XMM"
"image": "/Rules/Source/bestiary/fey/token/dire-worg-xmm.webp"
```{ #statblock}
