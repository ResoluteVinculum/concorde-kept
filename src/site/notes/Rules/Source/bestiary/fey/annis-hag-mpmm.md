---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/annis-hag-mpmm/","tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fey"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/mpmm","ttrpg-cli/monster/cr/6","ttrpg-cli/monster/environment/hill","ttrpg-cli/monster/environment/mountain","ttrpg-cli/monster/size/large","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Annis Hag"]}}
---

# [Annis Hag](Rules\Source\bestiary\fey/annis-hag-mpmm.md)
...
Much as annis hags befriend children in order to corrupt them, they may adopt a group of ogres, trolls, or other creatures ([[Rules/Source/bestiary/giant/ogre-xmm\|ogres]] and [[Rules/Source/bestiary/giant/troll-xmm\|trolls]]), ruling them through brute strength, insults, and superstition.
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 36\
      \ (9d6 + 5) bludgeoning damage, and the target is [grappled](/Rules/Source/conditions.md#Grappled)\
  ...
  - "desc": "The hag casts one of the following spells, using Charisma as the spellcasting\
      \ ability (spell save DC 13):\n\n**3/day each:** [disguise self](/Rules/Source/spells/disguise-self-xphb.md)\
      \ (including the form of a Medium Humanoid), [Fog cloud](/Rules/Source/spells/fog-cloud-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fey/token/annis-hag-mpmm.webp"
```{ #statblock}
