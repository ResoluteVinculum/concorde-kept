---
{"dg-publish":true,"permalink":"/rules/source/bestiary/fey/fey-spirit-xphb/","tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/fey"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-monster"],"tags":["ttrpg-cli/compendium/src/5e/xphb","ttrpg-cli/monster/cr/","ttrpg-cli/monster/size/small","ttrpg-cli/monster/type/fey"],"statblock":"inline","statblock-link":"#^statblock","aliases":["Fey Spirit"]}}
---

# [Fey Spirit](Rules\Source\bestiary\fey/fey-spirit-xphb.md)
...
"bonus_actions":
  - "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
      ...
      \ mood:\n\n- **Fuming.** The spirit has [Advantage](/Rules/Source/variant-rules/advantage-xphb.md)\
      ...
      \ can see within 10 feet of itself. *Failure:* The target is [Charmed](/Rules/Source/conditions.md#Charmed)\
      \ by you and the spirit for 1 minute or until the target takes any damage. \
      \ \n- **Tricksy.** The spirit fills a 10-foot [Cube](/Rules/Source/variant-rules/cube-area-of-effect-xphb.md)\
      \ within 5 feet of it with magical Darkness, which lasts until the end of its\
      \ next turn.  "
    "name": "Fey Step"
"source":
  - "XPHB"
"image": "/Rules/Source/bestiary/fey/token/fey-spirit-xphb.webp"
```
^statblock