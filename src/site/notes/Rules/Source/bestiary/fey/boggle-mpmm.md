...
"skillsaves":
  - "name": "[Perception](/Rules/Source/skills.md#Perception)"
    "desc": "+5"
  - "name": "[Sleight of Hand](/Rules/Source/skills.md#Sleight%20of%20Hand)"
    "desc": "+6"
...
"actions":
  ...
  - "desc": "The boggle creates a puddle of nonflammable oil. The puddle is 1 inch\
      ...
      \ must succeed on a DC 11 Dexterity saving throw or fall [prone](/Rules/Source/conditions.md#Prone).\
      \  \n- **Sticky Oil.** Any non-boggle creature that enters the puddle or starts\
      \ its turn there must succeed on a DC 11 Strength saving throw or be [restrained](/Rules/Source/conditions.md#Restrained).\
...
"bonus_actions":
  - "desc": "The boggle excretes nonflammable oil from its pores, giving itself one\
      ...
      \n- **Slippery Oil.** The boggle has advantage on Dexterity ([Acrobatics](/Rules/Source/skills.md#Acrobatics))\
      ...
      \ boggle has advantage on Strength ([Athletics](/Rules/Source/skills.md#Athletics))\
      ...
      \  "
    "name": "Boggle Oil"
  - "desc": "The boggle creates an [invisible](/Rules/Source/conditions.md#Invisible)\
...
"source":
  - "MPMM"
"image": "/Rules/Source/bestiary/fey/token/boggle-mpmm.webp"
```{ #statblock}
