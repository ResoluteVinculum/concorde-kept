---
{"dg-publish":true,"permalink":"/rules/source/books/tashas-cauldron-of-everything/5-dungeon-masters-tools/","tags":["ttrpg-cli/compendium/src/5e/tce"],"noteIcon":"","dg-note-properties":{"obsidianUIMode":"preview","cssclasses":["json5e-note"],"tags":["ttrpg-cli/compendium/src/5e/tce"],"aliases":["Dungeon Master's Tools"]}}
---
...
- A creature gains the [[Rules/Source/conditions#Frightened\|frightened]] condition.  
...
> 
> Legends are filled with natural forces and mundane objects that take on humanoid characteristics to guide or confound heroes: statues that sing, animals that whisper secrets, clouds that speak their mind. While monsters like elementals, [[Rules/Source/bestiary/elemental/galeb-duhr-xmm\|galeb duhr]], and [[Rules/Source/bestiary/plant/treant-xmm\|treants]] represent natural forces brought to life, not every chatty rock or sagacious stream needs a stat block. Perhaps your adventures take a party to a land where plants speak freely or a cursed realm where petrified souls beg for help. Don't feel restricted by the options in the "Monster Manual" or by the limitations of the [[Rules/Source/spells/animate-objects-xphb\|animate object]] spell should you want to breathe extra life into your story. Filling a witch's redoubt with murmuring relics, a fey forest with eavesdropping vegetation, or a sky god's temple with avian choirs makes a place especially memorable. Spells such as [[Rules/Source/spells/animate-objects-xphb\|animate objects]], [[Rules/Source/spells/awaken-xphb\|awaken]], [[Rules/Source/spells/speak-with-animals-xphb\|speak with animals]], [[Rules/Source/spells/speak-with-plants-xphb\|speak with plants]], and the like provide guidance on how to bring commonplace creatures and objects to life.{ #awaken-anything}
...
- [[Rules/Source/traps-hazards/flaywind-tce\|Flaywind]]  
- [[Rules/Source/traps-hazards/flame-storm-tce\|Flame Storm]]  
- [[Rules/Source/traps-hazards/necrotic-tempest-tce\|Necrotic Tempest]]  
...
Creatures proficient in the [[Rules/Source/skills#Medicine\|Medicine]], [[Rules/Source/skills#Nature\|Nature]], or [[Rules/Source/skills#Survival\|Survival]] skills might be versed on the subject of fungi, especially the magical kind, since the beneficial effects can save lives or bestow unusual powers. But when an unknown variety of fungus is encountered, only an expert can identify it and determine its properties.
...
Members of the colony develop telepathy and the ability to speak. While within 10 miles of the colony, any mimic can communicate telepathically with other creatures within 120 feet of it and can speak Common and Undercommon fluently (or two other languages of the DM's choice). The colony's offspring gain these abilities innately and can use them even away from the colony, as shown in the [[Rules/Source/bestiary/monstrosity/juvenile-mimic-tce\|Juvenile Mimic]] stat block.
...
- [[Rules/Source/traps-hazards/avalanche-tce\|Avalanche]]  
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/109-04-020.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/109-04-020.webp)
...
**Intelligence ([[Rules/Source/skills#Investigation\|Investigation]]) DC 10**. The character deduces that the number of creatures in a painting is important and uses that number to determine which letter of the creature's name they should review.

**Wisdom ([[Rules/Source/skills#Perception\|Perception]]) DC 10**. When looking at the dedication, the words "count on" alert the character that they should count the creatures.
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/110-04-021.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/110-04-021.webp)
...
**Intelligence ([[Rules/Source/skills#Arcana\|Arcana]]) DC 10**. The character sees one instance of a school of magic on the floor.

**Intelligence ([[Rules/Source/skills#Investigation\|Investigation]]) DC 10**. The character interprets the clue in the wall verse: there are eight schools of magic.

**Wisdom ([[Rules/Source/skills#Perception\|Perception]]) DC 10**. Each character who succeeds on this check sees an instance of the word "magic" in the floor.
...
- **Abjuration.** The trap casts [[Rules/Source/spells/dispel-magic-xphb\|dispel magic]] on each creature in the room, using a 9th-level spell slot.  
...
- **Enchantment.** The trap casts [[Rules/Source/spells/suggestion-xphb\|suggestion]] (save DC 15) on the creature that triggered it. On a failed save, a gentle voice only the creature can hear tells it to move 5 feet in a random direction. This movement might cause it to trigger another trap.  
...
- **Transmutation.** The trap casts [[Rules/Source/spells/polymorph-xphb\|polymorph]] (save DC 15) on the creature that triggered it. On a failed save, the creature turns into a [[Rules/Source/bestiary/beast/giant-frog-xmm\|giant frog]].  
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/112-04-023.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/112-04-023.webp)
...
Each lock has a creature molded in iron above it: a bat, snake, spider, or wolf, respectively. These locks can't be picked. If anything other than the correct key is placed inside a lock, creatures corresponding to the image above the lock (`1d4` [[Rules/Source/bestiary/beast/giant-bat-xmm\|giant bats]], `1d4` [[Rules/Source/bestiary/beast/giant-venomous-snake-xmm\|giant poisonous snakes]], `1d4` [[Rules/Source/bestiary/beast/giant-wolf-spider-xmm\|giant wolf spiders]], or `1d4` [[Rules/Source/bestiary/beast/wolf-xmm\|wolves]]) are summoned into the room. Each summoned creature is hostile and disappears after 10 minutes or when reduced to 0 hit points. These beasts can't be [[Rules/Source/conditions#Charmed\|charmed]] or [[Rules/Source/conditions#Frightened\|frightened]].
...
If a creature attempts to leave the room with any of these stones, the gem disappears and an angry spirit trapped inside it is released. The spirit manifests as a hostile undead creature of your choice, such as a [[Rules/Source/bestiary/undead/ghost-xmm\|ghost]], [[Rules/Source/bestiary/undead/specter-xmm\|specter]], or [[Rules/Source/bestiary/undead/skeleton-xmm\|skeleton]]. When this creature is reduced to 0 hit points, its form dissipates, leaving no trace of itself behind.
...
To make the puzzle easier to solve, a spirit can provide a hint in addition to giving its name. Coaxing a hint from a spirit requires a successful DC 15 Charisma ([[Rules/Source/skills#Persuasion\|Persuasion]] or [[Rules/Source/skills#Intimidation\|Intimidation]]) check. Consider hints like "A is the first letter in the alphabet" and "The gemstones, in order, will help for a spell."
...
Upon meeting the characters (and to discourage them from attacking), the goblin makes it clear there is no way out of the maze without his help. Characters can determine that the goblin is sincere in wanting to help with a successful DC 10 Wisdom ([[Rules/Source/skills#Insight\|Insight]]) check.
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/115-04-026.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/115-04-026.webp)
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/118-04-030.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/118-04-030.webp)

##### Bookcases

All around the wizard's study are shelves and cases filled with books, scrolls, and other supplies. A character who makes a successful DC 12 Intelligence ([[Rules/Source/skills#Arcana\|Arcana]]) check notices a spell component with no gp value from the list (such as a chip of mica or a bit of bat fur).
...
Wizards and other spellcasters can identify the correct spell components for any spell they know, but they must succeed on the Intelligence ([[Rules/Source/skills#Arcana\|Arcana]]) checks noted in the "Hint Checks" section below to recall the correct material components for any less familiar spells.
...
A guard stands on the other side of the door around the clock, and the only way to speak with the guard is through the door's slide window. The guard can be any sort of talking creature, such as an [[Rules/Source/bestiary/humanoid/assassin-xmm\|assassin]], a [[Rules/Source/bestiary/humanoid/cultist-fanatic-xmm\|cult fanatic]], or a [[Rules/Source/bestiary/humanoid/tough-xmm\|thug]]. More monstrous options include a [[Rules/Source/bestiary/fey/bugbear-warrior-xmm\|bugbear]], [[Rules/Source/bestiary/monstrosity/wereboar-xmm\|wereboar]], or [[Rules/Source/bestiary/fiend/nycaloth-xmm\|nycaloth]].
...
If the characters continue watching the door, they see up to four more visitors approach it. To eavesdrop on each exchange, the characters must succeed on a DC 12 group Dexterity ([[Rules/Source/skills#Stealth\|Stealth]]) check to remain hidden; if the group check fails, the visitor notices they're being observed and speaks quietly enough that their answer can't be overheard.
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/121-04-032.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/121-04-032.webp)
...
- If the improperly placed tile has an open triangle pointing downward, the [[Rules/Source/bestiary/elemental/water-elemental-xmm\|water elemental]] is freed.  
- If the improperly placed tile has an open triangle pointing upward, the [[Rules/Source/bestiary/elemental/fire-elemental-xmm\|fire elemental]] is freed.  
- If the improperly placed tile has a triangle pointing upward with a horizontal line running through it, the [[Rules/Source/bestiary/elemental/air-elemental-xmm\|air elemental]] is freed.  
- If the improperly placed tile has a triangle pointing downward with a horizontal line running through it, the [[Rules/Source/bestiary/elemental/earth-elemental-xmm\|earth elemental]] is freed.  

#### Solution

The correct, complete pattern is shown here:

![/Rules/Source/books/tashas-cauldron-of-everything/img/122-04-033.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/122-04-033.webp)
...
You can also raise the difficulty by having statues depict genies instead of elementals. In this case, replace the four elementals with a [[Rules/Source/bestiary/elemental/dao-xmm\|dao]], a [[Rules/Source/bestiary/elemental/djinni-xmm\|djinni]], an [[Rules/Source/bestiary/elemental/efreeti-xmm\|efreeti]], and a [[Rules/Source/bestiary/elemental/marid-xmm\|marid]]. These genies are compelled to attack the characters and can't be reasoned with.
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/123-04-034.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/123-04-034.webp)
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/124-04-035.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/124-04-035.webp)
...
![/Rules/Source/books/tashas-cauldron-of-everything/img/125-04-036.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/125-04-036.webp)

#### Puzzle Handout 2: Skeleton Keys

![/Rules/Source/books/tashas-cauldron-of-everything/img/126-04-037.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/126-04-037.webp)

#### Puzzle Handout 3: Four by Four

![/Rules/Source/books/tashas-cauldron-of-everything/img/127-04-038.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/127-04-038.webp)

#### Puzzle Handout 4: Illusive Island

![/Rules/Source/books/tashas-cauldron-of-everything/img/128-04-039.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/128-04-039.webp)

#### Puzzle Handout 5: Material Components

![/Rules/Source/books/tashas-cauldron-of-everything/img/129-04-040.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/129-04-040.webp)

#### Puzzle Handout 6: Four Elements

![/Rules/Source/books/tashas-cauldron-of-everything/img/130-04-041.webp\|center wmed](/img/user/Rules/Source/books/tashas-cauldron-of-everything/img/130-04-041.webp)